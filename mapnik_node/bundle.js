(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.oouyang = {}, global.http, global.https, global.url, global.assert, global.stream, global.tty, global.util, global.os, global.zlib));
  ...
  var jstsMap = function () {
    function jstsMap(options) {

      this.name = 'oouyang';
      this.version = version$1;
    }

    var _proto = jstsMap.prototype;

    _proto.getAreaInfoData = function getAreaInfoData(areacode) {
  ...
  var jstsMapObjet = new jstsMap();
  console.log(jstsMapObjet.getName());

  exports.default = jstsMap;
