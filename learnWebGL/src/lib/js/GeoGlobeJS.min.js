 ...
 * @Author: your name
 * @Date: 2019-10-11 10:40:26
 * @LastEditTime: 2019-10-11 10:40:26
...
function(a){for(var a=a.split("."),b=window,c=0;c<a.length;c++)b[a[c]]||(b[a[c]]={}),b=b[a[c]]};GeoGlobe.VERSION_NUMBER="GeoGlobeJSAPI 2019 -- $Version: 0.53.1 build-2019/10/9 12:38:557 $"})();GeoGlobe.Class=function(){var a=arguments.length,b=arguments[0],c=arguments[a-1],d=typeof c.initialize=="function"?c.initialize:function(){b.prototype.initialize.apply(this,arguments)};a>1?[d,b].concat(Array.prototype.slice.call(arguments).slice(1,a-1),c):d.prototype=c;return d};
...
GeoGlobe.Util.distVincenty=function(a,b){for(var c=GeoGlobe.Util.VincentyConstants,d=c.a,e=c.b,c=c.f,f=GeoGlobe.Util.rad(b.lng-a.lng),g=Math.atan((1-c)*Math.tan(GeoGlobe.Util.rad(a.lat))),h=Math.atan((1-c)*Math.tan(GeoGlobe.Util.rad(b.lat))),j=Math.sin(g),g=Math.cos(g),l=Math.sin(h),h=Math.cos(h),m=f,o=2*Math.PI,p=20;Math.abs(m-o)>1.0E-12&&--p>0;){var s=Math.sin(m),n=Math.cos(m),q=Math.sqrt(h*s*h*s+(g*l-j*h*n)*(g*l-j*h*n));if(q==0)return 0;var n=j*l+g*h*n,t=Math.atan2(q,n),r=Math.asin(g*h*s/q),u=
Math.cos(r)*Math.cos(r),s=n-2*j*l/u,v=c/16*u*(4+c*(4-3*u)),o=m,m=f+(1-v)*c*Math.sin(r)*(t+v*q*(s+v*n*(-1+2*s*s)))}if(p==0)return NaN;d=u*(d*d-e*e)/(e*e);c=d/1024*(256+d*(-128+d*(74-47*d)));return(e*(1+d/16384*(4096+d*(-768+d*(320-175*d))))*(t-c*q*(s+c/4*(n*(-1+2*s*s)-c/6*s*(-3+4*q*q)*(-3+4*s*s))))).toFixed(3)/1E3};
GeoGlobe.Util.destinationVincenty=function(a,b,c){for(var d=GeoGlobe.Util,e=d.VincentyConstants,f=e.a,g=e.b,e=e.f,h=a.lng,j=a.lat,a=d.rad(b),b=Math.sin(a),a=Math.cos(a),l=(1-e)*Math.tan(d.rad(j)),j=1/Math.sqrt(1+l*l),m=l*j,o=Math.atan2(l,a),l=j*b,p=1-l*l,f=p*(f*f-g*g)/(g*g),s=1+f/16384*(4096+f*(-768+f*(320-175*f))),n=f/1024*(256+f*(-128+f*(74-47*f))),f=c/(g*s),q=2*Math.PI;Math.abs(f-q)>1.0E-12;)var t=Math.cos(2*o+f),r=Math.sin(f),u=Math.cos(f),v=n*r*(t+n/4*(u*(-1+2*t*t)-n/6*t*(-3+4*r*r)*(-3+4*t*t))),
q=f,f=c/(g*s)+v;c=m*r-j*u*a;c=Math.atan2(m*u+j*r*a,(1-e)*Math.sqrt(l*l+c*c));g=e/16*p*(4+e*(4-3*p));return new GeoGlobe.LngLat(h+d.deg(Math.atan2(r*b,j*u-m*r*a)-(1-g)*e*l*(f+g*r*(t+g*u*(-1+2*t*t)))),d.deg(c))};
...
return e}else console.error("\u672a\u5f15\u5165turf.js\u5e93\uff01")};
...
1.58060784298199,8.77738589078284,0.37238884252424,7.45]];d.forward=b(function(b,c,d){for(var f=b[d];f>180;)f-=360;for(;f<-180;)f+=360;var b=b[d+1],b=Math.max(b,-74),b=Math.min(b,74),h=null,n;for(n=0;n<g.length;++n)if(b>=g[n]){h=j[n];break}if(h===null)for(n=g.length-1;n>=0;--n)if(b<=-g[n]){h=j[n];break}c[d]=f;c[d+1]=b;e(c,c,d,h)});d.inverse=b(function(b,c,d){for(var g=Math.abs(b[d+1]),j=null,n=0;n<f.length;n++)if(g>=f[n]){j=h[n];break}e(b,c,d,j)})},{"../util":8}],6:[function(b,c,d){d.baiduMercator=
...
new window.ActiveXObject("Microsoft.XMLDOM"),e.async=!1,e.validateOnParse=!1,e.loadXML(f);c=e&&(h&&e.parseError!=0||!e.documentElement||e.documentElement&&e.documentElement.tagName=="parsererror")?null:e;a.responseXML=c}catch(g){}try{a.status=a._object.status}catch(j){}try{a.statusText=a._object.statusText}catch(r){}}function e(a){a._object.onreadystatechange=new window.Function}var f=window.XMLHttpRequest,g=!!window.controllers,h=window.document.all&&!window.opera,j=h&&window.navigator.userAgent.match(/MSIE 7.0/);
b.prototype=a.prototype;if(g&&f.wrapped)b.wrapped=f.wrapped;b.UNSENT=0;b.OPENED=1;b.HEADERS_RECEIVED=2;b.LOADING=3;b.DONE=4;b.prototype.readyState=b.UNSENT;b.prototype.responseText="";b.prototype.responseXML=null;b.prototype.status=0;b.prototype.statusText="";b.prototype.priority="NORMAL";b.prototype.onreadystatechange=null;b.onreadystatechange=null;b.onopen=null;b.onsend=null;b.onabort=null;b.prototype.open=function(a,f,j,p,s){delete this._headers;arguments.length<3&&(j=!0);this._async=j;var n=this,
q=this.readyState,t;h&&j&&(t=function(){q!=b.DONE&&(e(n),n.abort())},window.attachEvent("onunload",t));b.onopen&&b.onopen.apply(this,arguments);arguments.length>4?this._object.open(a,f,j,p,s):arguments.length>3?this._object.open(a,f,j,p):this._object.open(a,f,j);try{this._object.responseType="msxml-document"}catch(r){}this.readyState=b.OPENED;c(this);this._object.onreadystatechange=function(){if(!g||j)n.readyState=n._object.readyState,d(n),n._aborted?n.readyState=b.UNSENT:(n.readyState==b.DONE&&(delete n._data,
e(n),h&&j&&window.detachEvent("onunload",t)),q!=n.readyState&&c(n),q=n.readyState)}};b.prototype.setTimeout=function(a){this._object.timeout=a};b.prototype.send=function(a){b.onsend&&b.onsend.apply(this,arguments);arguments.length||(a=null);a&&a.nodeType&&(a=window.XMLSerializer?(new window.XMLSerializer).serializeToString(a):a.xml,this._headers["Content-Type"]||this._object.setRequestHeader("Content-Type","application/xml"));this._data=a;this._object.send(this._data);if(g&&!this._async){this.readyState=
...
GeoGlobe.Map=GeoGlobe.Class(mapboxgl.FreeCRSMap,{pitch3Dzoom:16,is3Dpitching:!0,skipLevelOfZooming:!1,isAttributionControl:!0,isScrollZoom:!0,isBooxZoom:!0,isDragRotate:!0,isDragPan:!0,isKeyboard:!0,isDoubleClickZoom:!0,isTouchZoomRotate:!0,isTrackResize:!0,epsg:"EPSG:3857",units:null,initialize:function(a){this.options=a;if(a.isAttributionControl==!1)a.attributionControl=a.isAttributionControl;if(a.isScrollZoom==!1)a.scrollZoom=a.isScrollZoom;if(a.isBooxZoom==!1)a.boxZoom=a.isBooxZoom;if(a.isDragRotate==
!1)a.dragRotate=a.isDragRotate;if(a.isDragPan==!1)a.dragPan=a.isDragPan;if(a.isKeyboard==!1)a.keyboard=a.isKeyboard;if(a.isDoubleClickZoom==!1)a.doubleClickZoom=a.isDoubleClickZoom;if(a.isTouchZoomRotate==!1)a.touchZoomRotate=a.isTouchZoomRotate;if(a.isTrackResize==!1)a.trackResize=a.isTrackResize;if(!a.epsg)a.epsg="EPSG:3857";if(!a.units)a.units="degrees";if(!a.isConstrain)a.isConstrain=!1;this.map=new mapboxgl.FreeCRSMap(a);this.map.epsg=a.epsg;this.map.units=a.units;this.map.setIsConstrain(a.isConstrain);
this.map.pitch3Dzoom=this.options.pitch3Dzoom?this.options.pitch3Dzoom:16;this.map.setIs3DPZoom(this.options.is3Dpitching);return this.map},CLASS_NAME:"GeoGlobe.Map"});mapboxgl.FreeCRSMap.prototype.addCanvasLayer=function(a){a.addTo(this)};mapboxgl.FreeCRSMap.prototype.removeCanvasLayer=function(a){a.remove()};mapboxgl.FreeCRSMap.prototype.setIs3DPZoom=function(a){if(a)this.on("zoom",this.setZoompitch);else this.off("zoom",this.setZoompitch)};
mapboxgl.FreeCRSMap.prototype.set3Dzoom=function(a){if(a)this.pitch3Dzoom=a};mapboxgl.FreeCRSMap.prototype.setZoompitch=function(){var a=this.getZoom(),b=this.pitch3Dzoom;parseInt(a)==b&&this.setPitch(60)};mapboxgl.FreeCRSMap.prototype.addLayers=function(a){if(a.length>0)for(var b=0;b<a.length;b++)this.addLayer(a[b])};mapboxgl.FreeCRSMap.prototype.getResolutions=function(){for(var a=[],b=0;b<=20;b++)a.push(this.getResolutionForLevel(b));return a};
mapboxgl.FreeCRSMap.prototype.getResolutionForLevel=function(a,b){var c=Math.abs(this._tileExtent[2]-this._tileExtent[0]);c===360&&(c=4.00750166855784E7);return c/(b?b:256)/Math.pow(2,a)};mapboxgl.FreeCRSMap.prototype.setIsConstrain=function(a){this.isConstrain=a;this.transform._constraining=!this.isConstrain};
...
this.style.addLayer(a.layerOption,b),this._update(!0),this;if(a.layerOption&&a.layerOption.metadata.type==="hotarea")return a.addTo(this),this;if(typeof a.source==="object"&&this._mapCRS&&a.source&&a.source.type=="geojson"&&a.source.data&&!a.source.customprj&&(a.source.customprj=this._geojson_customprj,this._geojson_customprj_custompyramid))a.source.customprj_custompyramid=this._geojson_customprj_custompyramid;this.style.addLayer(a,b);this._update(!0);return this};
...
bbox:b.BBOX,format:b.format,f:b.f},d=this.urlAppend(a.url,this.getParameterString(b||{}));GeoGlobe.ProxyHost&&(d=GeoGlobe.appendToProxy(d));return{id:a.id?a.id:"GEO_ARCGIS_EXPORT",type:"raster",source:{type:"raster",tiles:[d],tileSize:b.size.split(",")[0]*1},metadata:c}},getParameterString:function(a){var b=[],c;for(c in a){var d=a[c];if(d!=null&&typeof d!="function"){if(typeof d=="object"&&d.constructor==Array){for(var e=[],f,g=0,h=d.length;g<h;g++)f=d[g],e.push(encodeURIComponent(f===null||f===
void 0?"":f));d=e.join(",")}b.push(encodeURIComponent(c)+"="+d)}}return b.join("&")},urlAppend:function(a,b){var c=a;if(b){var d=(a+" ").split(/[?&]/);c+=d.pop()===" "?b:d.length?"&"+b:"?"+b}return c},CLASS_NAME:"GeoGlobe.Layer.Export"});
...
GeoGlobe.Source.RasterSource=GeoGlobe.Class(mapboxgl.FreeCRSMap,{initialize:function(a){return{id:a.id,type:"raster",tiles:a.url,tileSize:a.tileSize?a.tileSize:256,zoomOffset:a.zoomOffset?a.zoomOffset:0}},CLASS_NAME:"GeoGlobe.Source.RasterSource"});GeoGlobe.Source.ImageSource=GeoGlobe.Class(mapboxgl.FreeCRSMap,{initialize:function(a,b){var c={};c.id=a;c.source=b;return c},CLASS_NAME:"GeoGlobe.Source.ImageSource"});
GeoGlobe.Source.VectorSource=GeoGlobe.Class(mapboxgl.FreeCRSMap,{initialize:function(a){return{id:a.id,type:a.type,tiles:a.url}},CLASS_NAME:"GeoGlobe.Source.VectorSource"});GeoGlobe.Source.VideoSource=GeoGlobe.Class(mapboxgl.FreeCRSMap,{initialize:function(a,b){var c={};c.id=a;c.video=b;return c},CLASS_NAME:"GeoGlobe.Source.VideoSource"});GeoGlobe.Marker=mapboxgl.Marker;GeoGlobe.Popup=mapboxgl.Popup;GeoGlobe.Control=mapboxgl.Control||{};GeoGlobe.Control.Navigation=mapboxgl.NavigationControl;
...
GeoGlobe.Geometry.segmentsIntersect=function(a,b,c){var d=c&&c.point,c=c&&c.tolerance,e=!1,f=a.x1-b.x1,g=a.y1-b.y1,h=a.x2-a.x1,j=a.y2-a.y1,l=b.y2-b.y1,m=b.x2-b.x1,o=l*h-m*j,l=m*g-l*f,g=h*g-j*f;o==0?l==0&&g==0&&(e=!0):(f=l/o,o=g/o,f>=0&&f<=1&&o>=0&&o<=1&&(d?(h=a.x1+f*h,o=a.y1+f*j,e=new GeoGlobe.Geometry.Point(h,o)):e=!0));if(c)if(e){if(d){a=[a,b];b=0;a:for(;b<2;++b){f=a[b];for(j=1;j<3;++j)if(h=f["x"+j],o=f["y"+j],d=Math.sqrt(Math.pow(h-e.x,2)+Math.pow(o-e.y,2)),d<c){e.x=h;e.y=o;break a}}}}else{a=[a,
...
e,f,g,h,j,l,m,o=0,p=d.length;a:for(;o<p;++o){c=d[o];e=c.x1;f=c.x2;g=c.y1;h=c.y2;var s=0,n=a.length;for(;s<n;++s){j=a[s];if(j.x1>f)break;if(!(j.x2<e)&&(l=j.y1,m=j.y2,!(Math.min(l,m)>Math.max(g,h))&&!(Math.max(l,m)<Math.min(g,h))&&GeoGlobe.Geometry.segmentsIntersect(c,j))){b=!0;break a}}}}else b=a.intersects(this);return b},getSortedSegments:function(){for(var a=this.components.length-1,b=Array(a),c,d,e=0;e<a;++e)c=this.components[e],d=this.components[e+1],b[e]=c.x<d.x?{x1:c.x,y1:c.y,x2:d.x,y2:d.y}:
{x1:d.x,y1:d.y,x2:c.x,y2:c.y};return b.sort(function(a,b){return a.x1-b.x1})},splitWithSegment:function(a,b){for(var c=!(b&&b.edge===!1),d=b&&b.tolerance,e=[],f=this.getVertices(),g=[],h=[],j=!1,l,m,o,p={point:!0,tolerance:d},s=null,n=0,q=f.length-2;n<=q;++n)if(d=f[n],g.push(d.clone()),l=f[n+1],m={x1:d.x,y1:d.y,x2:l.x,y2:l.y},m=GeoGlobe.Geometry.segmentsIntersect(a,m,p),m instanceof GeoGlobe.Geometry.Point&&((o=m.x===a.x1&&m.y===a.y1||m.x===a.x2&&m.y===a.y2||m.equals(d)||m.equals(l)?!0:!1)||c))m.equals(h[h.length-
1])||h.push(m.clone()),!(n===0&&m.equals(d))&&!m.equals(l)&&(j=!0,m.equals(d)||g.push(m),e.push(new GeoGlobe.Geometry.LineString(g)),g=[m.clone()]);j&&(g.push(l.clone()),e.push(new GeoGlobe.Geometry.LineString(g)));if(h.length>0)var t=a.x1<a.x2?1:-1,r=a.y1<a.y2?1:-1,s={lines:e,points:h.sort(function(a,b){return t*a.x-t*b.x||r*a.y-r*b.y})};return s},split:function(a,b){var c=null,d=b&&b.mutual,e,f,g,h;if(a instanceof GeoGlobe.Geometry.LineString){var j=this.getVertices(),l,m,o,p,s,n=[];g=[];for(var q=
0,t=j.length-2;q<=t;++q){l=j[q];m=j[q+1];o={x1:l.x,y1:l.y,x2:m.x,y2:m.y};h=h||[a];d&&n.push(l.clone());for(var r=0;r<h.length;++r)if(p=h[r].splitWithSegment(o,b))if(s=p.lines,s.length>0&&(s.unshift(r,1),Array.prototype.splice.apply(h,s),r+=s.length-2),d)for(var u=0,v=p.points.length;u<v;++u)s=p.points[u],s.equals(l)||(n.push(s),g.push(new GeoGlobe.Geometry.LineString(n)),n=s.equals(m)?[]:[s.clone()])}d&&g.length>0&&n.length>0&&(n.push(m.clone()),g.push(new GeoGlobe.Geometry.LineString(n)))}else c=
...
h=a.x,j=a.y,l,m=0,o=g.length;m<o;++m)if(l=g[m],d=GeoGlobe.Geometry.distanceToSegment(a,l),d.distance<f){if(f=d.distance,e=d,f===0)break}else if(l.x2>h&&(j>l.y1&&j<l.y2||j<l.y1&&j>l.y2))break;e=c?{distance:e.distance,x0:e.x,y0:e.y,x1:h,y1:j}:e.distance}else if(a instanceof GeoGlobe.Geometry.LineString){var g=this.getSortedSegments(),h=a.getSortedSegments(),p,s,n=h.length,q={point:!0},m=0,o=g.length;a:for(;m<o;++m){j=g[m];l=j.x1;s=j.y1;for(var t=0;t<n;++t)if(d=h[t],p=GeoGlobe.Geometry.segmentsIntersect(j,
d,q)){f=0;e={distance:0,x0:p.x,y0:p.y,x1:p.x,y1:p.y};break a}else if(d=GeoGlobe.Geometry.distanceToSegment({x:l,y:s},d),d.distance<f)f=d.distance,e={distance:f,x0:l,y0:s,x1:d.x,y1:d.y}}if(!c)e=e.distance;f!==0&&j&&(d=a.distanceTo(new GeoGlobe.Geometry.Point(j.x2,j.y2),b),m=c?d.distance:d,m<f&&(e=c?{distance:f,x0:d.x1,y0:d.y1,x1:d.x0,y1:d.y0}:m))}else e=a.distanceTo(this,b),c&&(e={distance:e.distance,x0:e.x1,y0:e.y1,x1:e.x0,y1:e.y0});return e},simplify:function(a){if(this&&this!==null){var b=this.getVertices();
if(b.length<3)return this;var c=function(a,b,d,j){for(var l=0,m=0,o=b,p;o<d;o++)p=Math.abs(0.5*(a[b].x*a[d].y+a[d].x*a[o].y+a[o].x*a[b].y-a[d].x*a[b].y-a[o].x*a[d].y-a[b].x*a[o].y))/Math.sqrt(Math.pow(a[b].x-a[d].x,2)+Math.pow(a[b].y-a[d].y,2))*2,p>l&&(l=p,m=o);l>j&&m!=b&&(e.push(m),c(a,b,m,j),c(a,m,d,j))},d=b.length-1,e=[];e.push(0);for(e.push(d);b[0].equals(b[d]);)d--,e.push(d);c(b,0,d,a);a=[];e.sort(function(a,b){return a-b});for(d=0;d<e.length;d++)a.push(b[e[d]]);return new GeoGlobe.Geometry.LineString(a)}else return this},
...
GeoGlobe.Geometry.MultiLineString=GeoGlobe.Class4OL(GeoGlobe.Geometry.Collection,{componentTypes:["GeoGlobe.Geometry.LineString"],split:function(a,b){for(var c=null,d=b&&b.mutual,e,f,g,h,j=[],l=[a],m=0,o=this.components.length;m<o;++m){f=this.components[m];g=!1;for(var p=0;p<l.length;++p)if(e=f.split(l[p],b)){if(d){g=e[0];for(var s=0,n=g.length;s<n;++s)s===0&&j.length?j[j.length-1].addComponent(g[s]):j.push(new GeoGlobe.Geometry.MultiLineString([g[s]]));g=!0;e=e[1]}if(e.length){e.unshift(p,1);Array.prototype.splice.apply(l,
e);break}}g||(j.length?j[j.length-1].addComponent(f.clone()):j=[new GeoGlobe.Geometry.MultiLineString(f.clone())])}j&&j.length>1?g=!0:j=[];l&&l.length>1?h=!0:l=[];if(g||h)c=d?[j,l]:l;return c},splitWith:function(a,b){var c=null,d=b&&b.mutual,e,f,g,h,j,l;if(a instanceof GeoGlobe.Geometry.LineString){l=[];j=[a];for(var m=0,o=this.components.length;m<o;++m){g=!1;f=this.components[m];for(var p=0;p<j.length;++p)if(e=j[p].split(f,b)){d&&(g=e[0],g.length&&(g.unshift(p,1),Array.prototype.splice.apply(j,g),
p+=g.length-2),e=e[1],e.length===0&&(e=[f.clone()]));g=0;for(var s=e.length;g<s;++g)g===0&&l.length?l[l.length-1].addComponent(e[g]):l.push(new GeoGlobe.Geometry.MultiLineString([e[g]]));g=!0}g||(l.length?l[l.length-1].addComponent(f.clone()):l=[new GeoGlobe.Geometry.MultiLineString([f.clone()])])}}else c=a.split(this);j&&j.length>1?h=!0:j=[];l&&l.length>1?g=!0:l=[];if(h||g)c=d?[j,l]:l;return c},CLASS_NAME:"GeoGlobe.Geometry.MultiLineString"});
...
a.features?a.features.length:0,c=Array(b),e=0;e<b;++e)c[e]=a.features[e].fid;n.insertIds=c;d.apply(this,[a])}function d(a){this.callUserCallback(a,b);s=s&&a.success();f++;if(f>=p&&b.callback)n.code=s?GeoGlobe.Protocol.Response.SUCCESS:GeoGlobe.Protocol.Response.FAILURE,b.callback.apply(b.scope,[n])}var b=GeoGlobe.Util.applyDefaults(b,this.options),e=[],f=0,g={};g[GeoGlobe.State.INSERT]=[];g[GeoGlobe.State.UPDATE]=[];g[GeoGlobe.State.DELETE]=[];for(var h,j,l=[],m=0,o=a.length;m<o;++m)if(h=a[m],j=g[h.state])j.push(h),
l.push(h);var p=(g[GeoGlobe.State.INSERT].length>0?1:0)+g[GeoGlobe.State.UPDATE].length+g[GeoGlobe.State.DELETE].length,s=!0,n=new GeoGlobe.Protocol.Response({reqFeatures:l});h=g[GeoGlobe.State.INSERT];h.length>0&&e.push(this.create(h,GeoGlobe.Util.applyDefaults({callback:c,scope:this},b.create)));h=g[GeoGlobe.State.UPDATE];for(m=h.length-1;m>=0;--m)e.push(this.update(h[m],GeoGlobe.Util.applyDefaults({callback:d,scope:this},b.update)));h=g[GeoGlobe.State.DELETE];for(m=h.length-1;m>=0;--m)e.push(this["delete"](h[m],
...
"$1:$3")===c.projection){h=d.tileMatrixSets[e.tileMatrixSetLinks[f].tileMatrixSet];break}}else e.tileMatrixSetLinks.length>=1&&(h=d.tileMatrixSets[e.tileMatrixSetLinks[0].tileMatrixSet]);if(!h)throw Error("matrixSet not found");var l=[];c.styleName&&c.styleName!=""?l[0]=c.styleName:this.GetStyleName(function(a){l=a});(f=c.requestEncoding)||(f="KVP");f=[];g=c.params||{};delete c.params;for(var j=0,m=e.dimensions.length;j<m;j++){var o=e.dimensions[j];f.push(o.identifier);g.hasOwnProperty(o.identifier)||
(g[o.identifier]=o["default"])}for(var p=c.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),s=c.units||(p==="EPSG:4326"?"degrees":"m"),n=[],q,t,c=[],m=e.tileMatrixSetLinks,g=function(a){n.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[s]);if(!q||q>a)q=a;if(!t||t<a)t=a},o=0,j=m.length;o<j;o++)if(f=m[o],f.tileMatrixSet===h.identifier){if(f.tileMatrixSetLimits){for(var j={},o=0,r=h.matrixIds.length;o<r;o++)j[h.matrixIds[o].identifier]=h.matrixIds[o];o=
0;for(r=f.tileMatrixSetLimits.length;o<r;o++)m=j[f.tileMatrixSetLimits[o].tileMatrix],c.push(m),g(m.scaleDenominator)}else{o=0;for(r=h.matrixIds.length;o<r;o++)g(h.matrixIds[o].scaleDenominator)}break}n.sort(function(a,b){return b-a});var u="",v={layers:[],source:{},source_id:"",url:"",url_tmpl:"",layerType:"VTS"},b=this.getParameterString({SERVICE:"WMTS",REQUEST:"GetTile",VERSION:b.version,LAYER:e.identifier,TILEMATRIXSET:h.identifier,FORMAT:"protobuf",TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"});
v.url=a;u=a.endsWith("?")||a.endsWith("&")?GeoGlobe.ProxyHost+a+b:GeoGlobe.ProxyHost+a+"?"+b;v.url_tmpl=u;GeoGlobe.Util.randomStr(10);if(e.bounds)var w=[e.bounds._sw.lng,e.bounds._sw.lat,e.bounds._ne.lng,e.bounds._ne.lat];else e.BoundingBox&&(w=e.BoundingBox[0].bounds.toBBOX());var x=d.tileMatrixSets[e.tileMatrixSetLinks[0].tileMatrixSet].matrixIds[0].identifier;this.GetStyle(l[0],function(a){var b={name:e.identifier,sprite:a.sprite?GeoGlobe.ProxyHost+a.sprite:"",glyphs:a.glyphs?GeoGlobe.ProxyHost+
a.glyphs:"",styleName:a.styleName,srs:p,bbox:w,format:e.formats,zoomoffset:x},c="source_vts_"+GeoGlobe.Util.randomStr(6);v.source_id=c;v.source={type:"vector",tiles:[u]};if(a.styleData)for(var d=0;d<a.styleData.layers.length;d++)a.styleData.layers[d].metadata=b,a.styleData.layers[d].source=c,v.layers[d]=a.styleData.layers[d];else for(d=0;d<a.layers.length;d++)a.layers[d].metadata=b,a.layers[d].source=c,v.layers[d]=a.layers[d]},function(){alert("WMTS\u670d\u52a1\u8bf7\u6c42\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u670d\u52a1\u662f\u5426\u6b63\u5e38\u8fd0\u884c\u6216\u8bf7\u6c42\u5730\u5740\u662f\u5426\u6b63\u786e\u3002\n\u8bf7\u6c42\u5730\u5740\uff1a"+
...
"$1:$3")===c.projection){j=d.tileMatrixSets[e.tileMatrixSetLinks[f].tileMatrixSet];break}}else e.tileMatrixSetLinks.length>=1&&(j=d.tileMatrixSets[e.tileMatrixSetLinks[0].tileMatrixSet]);if(!j)throw Error("matrixSet not found");for(var m,f=0,g=e.styles.length;f<g;++f)if(m=e.styles[f],m.isDefault)break;(f=c.requestEncoding)||(f="KVP");f=[];g=c.params||{};delete c.params;for(var o=0,l=e.dimensions.length;o<l;o++){var p=e.dimensions[o];f.push(p.identifier);g.hasOwnProperty(p.identifier)||(g[p.identifier]=
p["default"])}for(var f=c.projection||j.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),s=c.units||(f==="EPSG:4326"?"degrees":"m"),n=[],q,t,c=[],p=e.tileMatrixSetLinks,o=function(a){n.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[s]);if(!q||q>a)q=a;if(!t||t<a)t=a},r=0,l=p.length;r<l;r++)if(g=p[r],g.tileMatrixSet===j.identifier){if(g.tileMatrixSetLimits){for(var l={},r=0,u=j.matrixIds.length;r<u;r++)l[j.matrixIds[r].identifier]=j.matrixIds[r];r=0;for(u=g.tileMatrixSetLimits.length;r<
u;r++)p=l[g.tileMatrixSetLimits[r].tileMatrix],c.push(p),o(p.scaleDenominator)}else{r=0;for(u=j.matrixIds.length;r<u;r++)o(j.matrixIds[r].scaleDenominator)}break}n.sort(function(a,b){return b-a});c="";b=this.getParameterString({SERVICE:"WMTS",REQUEST:"GetTile",VERSION:b.version,LAYER:e.identifier,STYLE:m.identifier,TILEMATRIXSET:j.identifier,FORMAT:h,TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"});c=a.endsWith("?")||a.endsWith("&")?GeoGlobe.ProxyHost+a+b:GeoGlobe.ProxyHost+a+"?"+b;a=GeoGlobe.Util.randomStr(10);
...
d.styles.length)e=d.styles[0].name;var f=eval(d.srs),g,h;for(h in f)g=h;h="";h=c.transparent;c.isTile?(c=this.getParameterString({SERVICE:"WMS",REQUEST:"GetMap",VERSION:"1.1.1",LAYERS:d.name,styles:e,FORMAT:b,TRANSPARENT:h,BBOX:"{bbox-epsg-3857}",WIDTH:"256",HEIGHT:"256",SRS:g}),h=a.endsWith("?")||a.endsWith("&")?a+c:a+"?"+c,h=GeoGlobe.appendToProxy(h),a=GeoGlobe.Util.randomStr(10),d={id:"layer_"+d.name+"_"+a,type:"raster",source:{type:"raster",tiles:[h],tileSize:256},metadata:{name:d.name,srs:g,
bbox:d.bbox,format:b},paint:{"raster-opacity":1}}):d=new GeoGlobe.Layer.WMS({url:a,layer:d.name,format:b,version:"1.1.1",SRS:g,styles:e,bbox:d.bbox,isTile:!1});return d},createLayer:function(a,b,c){this.url=a;var b=b?b:{},c=c===void 0||c?!0:!1,d=b&&b.transparent===void 0||b.transparent?!0:!1,e=this.getWMSCapabilities(a);return this.createLayerOption(a,e,{layer:b&&b.layer?b.layer:e.capability.layers[0].name,transparent:d,isTile:c})},createLayers:function(a,b,c){for(var b=b?b:{},c=c===void 0||c?!0:
!1,b=b&&b.transparent===void 0||b.transparent?!0:!1,d=this.getWMSCapabilities(a),e=d.capability.layers,f=[],g=0;g<e.length;g++){var h=this.createLayerOption(a,d,{layer:e[g].name,transparent:b,isTile:c});f.push(h)}return f},getParameterString:function(a){var b=[],c;for(c in a){var d=a[c];d!=null&&typeof d!="function"&&b.push(c+"="+d)}return b.join("&")},CLASS_NAME:"GeoGlobe.Format.WMS"});
GeoGlobe.Format.WMSCapabilities=GeoGlobe.Class4OL(GeoGlobe.Format.XML.VersionedOGC,{defaultVersion:"1.1.1",profile:null,CLASS_NAME:"GeoGlobe.Format.WMSCapabilities"});
...
a.getAttribute("opaque"):null,h=a.getAttribute("noSubsets"),j=a.getAttribute("fixedWidth"),l=a.getAttribute("fixedHeight"),m=c||{},o=GeoGlobe.Util.extend;c={nestedLayers:[],styles:c?[].concat(c.styles):[],srs:c?o({},m.srs):{},metadataURLs:[],bbox:c?o({},m.bbox):{},llbbox:m.llbbox,dimensions:c?o({},m.dimensions):{},authorityURLs:c?o({},m.authorityURLs):{},identifiers:{},keywords:[],queryable:f&&f!==""?f==="1"||f==="true":m.queryable||!1,cascaded:g!==null?parseInt(g):m.cascaded||0,opaque:e?e==="1"||
...
(c="KVP");var m=[],e=b.params||{};delete b.params;f=0;for(j=d.dimensions.length;f<j;f++){var o=d.dimensions[f];m.push(o.identifier);e.hasOwnProperty(o.identifier)||(e[o.identifier]=o["default"])}for(var m=b.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),p=b.units||(m==="EPSG:4326"?"degrees":"m"),s=[],n,q,m=[],o=d.tileMatrixSetLinks,f=function(a){s.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[p]);if(!n||n>a)n=a;if(!q||q<a)q=a},t=0,j=o.length;t<j;t++)if(e=
o[t],e.tileMatrixSet===h.identifier){if(e.tileMatrixSetLimits){for(var j={},t=0,r=h.matrixIds.length;t<r;t++)j[h.matrixIds[t].identifier]=h.matrixIds[t];t=0;for(r=e.tileMatrixSetLimits.length;t<r;t++)o=j[e.tileMatrixSetLimits[t].tileMatrix],m.push(o),f(o.scaleDenominator)}else{t=0;for(r=h.matrixIds.length;t<r;t++)f(h.matrixIds[t].scaleDenominator)}break}if(c==="REST"&&d.resourceUrls){m=[];e=0;for(f=d.resourceUrls.length;e<f;++e)c=d.resourceUrls[e],c.format===g&&c.resourceType==="tile"&&m.push(c.template)}else{j=
a.operationsMetadata.GetTile.dcp.http.get;m=[];e=0;for(f=j.length;e<f;e++)o=j[e].constraints,(!o||o&&o.GetEncoding.allowedValues[c])&&m.push(j[e].url)}s.sort(function(a,b){return b-a});c="";g="SERVICE=WMTS&REQUEST=GetTile&VERSION="+a.version+"&LAYER="+d.identifier+"&STYLE="+l.identifier+"&TILEMATRIXSET="+h.identifier+"&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&FORMAT="+g;c=m[0].endsWith("?")?m[0]+g:m[0]+"?"+g;g=GeoGlobe.Util.applyDefaults(b,{id:d.identifier,url:[c]});g=new GeoGlobe.Layer.VTS(g);g.matrixSet=
...
"$1:$3")===c.projection){j=d.tileMatrixSets[e.tileMatrixSetLinks[f].tileMatrixSet];break}}else e.tileMatrixSetLinks.length>=1&&(j=d.tileMatrixSets[e.tileMatrixSetLinks[0].tileMatrixSet]);if(!j)throw Error("matrixSet not found");for(var l,f=0,g=e.styles.length;f<g;++f)if(l=e.styles[f],l.isDefault)break;(d=c.requestEncoding)||(d="KVP");d=[];f=c.params||{};delete c.params;for(var g=0,m=e.dimensions.length;g<m;g++){var o=e.dimensions[g];d.push(o.identifier);f.hasOwnProperty(o.identifier)||(f[o.identifier]=
o["default"])}for(var d=c.projection||j.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),p=c.units||(d==="EPSG:4326"?"degrees":"m"),s=[],n,q,c=[],m=e.tileMatrixSetLinks,f=function(a){s.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[p]);if(!n||n>a)n=a;if(!q||q<a)q=a},o=0,g=m.length;o<g;o++)if(d=m[o],d.tileMatrixSet===j.identifier){if(d.tileMatrixSetLimits){for(var g={},o=0,t=j.matrixIds.length;o<t;o++)g[j.matrixIds[o].identifier]=j.matrixIds[o];o=0;for(t=d.tileMatrixSetLimits.length;o<
t;o++)m=g[d.tileMatrixSetLimits[o].tileMatrix],c.push(m),f(m.scaleDenominator)}else{o=0;for(t=j.matrixIds.length;o<t;o++)f(j.matrixIds[o].scaleDenominator)}break}s.sort(function(a,b){return b-a});c="";b=this.getParameterString({SERVICE:"WMTS",REQUEST:"GetTile",VERSION:b.version,LAYER:e.identifier,STYLE:l.identifier,TILEMATRIXSET:j.identifier,FORMAT:h,TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"});c=a.endsWith("?")||a.endsWith("&")?GeoGlobe.ProxyHost+a+b:GeoGlobe.ProxyHost+a+"?"+b;a=GeoGlobe.Util.randomStr(10);
return{id:"layer_"+e.identifier+"_"+a,type:"raster",source:{type:"raster",tiles:[c],tileSize:256},paint:{"raster-opacity":1}}},createLayer:function(a){var b=this.getWMTSCapabilities(a);return this.createLayerOption(a,b,{layer:b.contents.layers[0].identifier})},createLayers:function(a){for(var b=this.getWMTSCapabilities(a),c=b.contents.layers,d=[],e=0;e<c.length;e++){var f=this.createLayerOption(a,b,{layer:c[e].identifier});d.push(f)}return d},getParameterString:function(a){var b=[],c;for(c in a){var d=
a[c];d!=null&&typeof d!="function"&&b.push(c+"="+d)}return b.join("&")},calculationTopTileExtentAndZoomOffset:function(a){var b={},c=null,d=0.0254,e=111E3,f=96,g=[],h=[];a.units=a.units?a.units:"degrees";if(a.hasOwnProperty("inchConvertMeterRatio"))d=a.inchConvertMeterRatio;if(a.hasOwnProperty("degreeConvertMeterRatio"))e=a.degreeConvertMeterRatio;if(a.hasOwnProperty("dpi"))f=a.dpi;var j=Math.ceil(Math.log(Math.max(Number(a.matrixWidth),Number(a.matrixHeight)))/Math.LN2),l=Math.pow(2,j);if(a.hasOwnProperty("resolution"))if(a.resolution!==
"")c=a.resolution;else{alert("\u8bf7\u8f93\u5165resolution\u503c\uff0c\u6216\u8005\u5c06\u8be5\u5c5e\u6027\u6ce8\u91ca");return}else if(a.units=="m"&&(c=a.scaleDenominator*d/f),a.units=="degrees"&&(c=a.scaleDenominator*d/(f*e)),a.units!=="m"&&a.units!=="degrees"){alert("\u8bf7\u786e\u5b9a\u5355\u4f4d\u662fm\u8fd8\u662fdegrees");return}g[0]=a.topLeftCorner[0];g[3]=a.topLeftCorner[1];g[1]=g[3]-a.tileSize*c*l;g[2]=g[0]+a.tileSize*c*l;d=j-Number(a.identifier);h[0]=(g[0]+g[2])/2;h[1]=(g[1]+g[3])/2;e=d-
1;if((g[2]-g[0]<360||g[3]-g[1]<360)&&a.units=="degrees")e=Math.ceil(Math.log(360/(a.tileSize*c*l))/Math.LN2),f=Math.pow(2,e),g[1]=g[3]-a.tileSize*c*l*f,g[2]=g[0]+a.tileSize*c*l*f,h[0]=(g[0]+g[2])/2,h[1]=(g[1]+g[3])/2,d+=e,e=d-1;b.topTileExtent=g;b.zoomOffset=d;b.centerPoint=h;b.proposalZoom=e;return b},CLASS_NAME:"GeoGlobe.Format.WMTSUtil"});GeoGlobe.Format.WPSCapabilities=GeoGlobe.Class4OL(GeoGlobe.Format.XML.VersionedOGC,{defaultVersion:"1.0.0",CLASS_NAME:"GeoGlobe.Format.WPSCapabilities"});
...
"-":"+")=="-"?-1*b:b),c.setMinutes(c.getMinutes()-b-c.getTimezoneOffset())):a.indexOf("Z",a.length-1)!==-1&&(c=new Date(Date.UTC(c.getFullYear(),c.getMonth(),c.getDate(),c.getHours(),c.getMinutes(),c.getSeconds(),c.getMilliseconds())));return c}function g(b,c,e){return a.datetimeAccessFormPaths.length>0?(e=e.split(".#")[0],d(a.datetimeAccessFormPaths,b,c,e)?f(b):b):b}function h(c,f){if(c.nodeType==q.DOCUMENT_NODE){for(var j={},o=c.childNodes,l=0;l<o.length;l++){var n=o.item(l);if(n.nodeType==q.ELEMENT_NODE){var m=
b(n);j[m]=h(n,m)}}return j}else if(c.nodeType==q.ELEMENT_NODE){j={};j.__cnt=0;o=c.childNodes;for(l=0;l<o.length;l++)if(n=o.item(l),m=b(n),n.nodeType!=q.COMMENT_NODE){var p=f+"."+m;if(n.nodeType==q.ELEMENT_NODE&&a.xmlElementsFilter.length>0?d(a.xmlElementsFilter,j,m,p):1)j.__cnt++,j[m]==null?(j[m]=h(n,p),e(j,m,p)):(j[m]!=null&&!(j[m]instanceof Array)&&(j[m]=[j[m]],e(j,m,p)),j[m][j[m].length]=h(n,p))}for(o=0;o<c.attributes.length;o++)l=c.attributes.item(o),j.__cnt++,j[a.attributePrefix+l.name]=l.value;
o=c.prefix;if(o!=null&&o!="")j.__cnt++,j.__prefix=o;if(j["#text"]!=null){j.__text=j["#text"];if(j.__text instanceof Array)j.__text=j.__text.join("\n");if(a.stripWhitespaces)j.__text=j.__text.trim();delete j["#text"];a.arrayAccessForm=="property"&&delete j["#text_asArray"];j.__text=g(j.__text,m,f+"."+m)}if(j["#cdata-section"]!=null)j.__cdata=j["#cdata-section"],delete j["#cdata-section"],a.arrayAccessForm=="property"&&delete j["#cdata-section_asArray"];j.__cnt==0&&a.emptyNodeForm=="text"?j="":j.__cnt==
1&&j.__text!=null?j=j.__text:j.__cnt==1&&j.__cdata!=null&&!a.keepCData?j=j.__cdata:j.__cnt>1&&j.__text!=null&&a.skipEmptyTextNodesForObj&&(a.stripWhitespaces&&j.__text==""||j.__text.trim()=="")&&delete j.__text;delete j.__cnt;if(a.enableToStringFunc&&(j.__text!=null||j.__cdata!=null))j.toString=function(){return(this.__text!=null?this.__text:"")+(this.__cdata!=null?this.__cdata:"")};return j}else if(c.nodeType==q.TEXT_NODE||c.nodeType==q.CDATA_SECTION_NODE)return c.nodeValue}function j(b,d,e,f){d=
...
b[c]instanceof Function?!0:!1}function o(a){var b=0;if(a instanceof Object)for(var c in a)m(a,c)||b++;return b}function p(b){var c=[];if(b instanceof Object)for(var d in b)d.toString().indexOf("__")==-1&&d.toString().indexOf(a.attributePrefix)==0&&c.push(d);return c}function s(b){var d="";if(b instanceof Object){var e="";b.__cdata!=null&&(e+="<![CDATA["+b.__cdata+"]]\>");b.__text!=null&&(e+=a.escapeMode?c(b.__text):b.__text);d+=e}else b!=null&&(d+=a.escapeMode?c(b):b);return d}function n(b,c){var e=
"";if(o(b)>0)for(var f in b){var g;if(!(g=m(b,f)))if(g=c!="")g=c===""?f:c+"."+f,g=!(a.jsonPropertiesFilter.length==0||g==""||d(a.jsonPropertiesFilter,b,f,g));if(!g){var h=b[f];g=p(h);if(h==null||h==void 0)e+=j(h,f,g,!0);else if(h instanceof Object)if(h instanceof Array){var q=f,B=c,A="";if(h.length==0)A+=j(h,q,g,!0);else for(g=0;g<h.length;g++)A+=j(h[g],q,p(h[g]),!1),A+=n(h[g],B===""?q:B+"."+q),A+=l(h[g],q);e+=A}else h instanceof Date?(e+=j(h,f,g,!1),e+=h.toISOString(),e+=l(h,f)):o(h)>0||h.__text!=
null||h.__cdata!=null?(e+=j(h,f,g,!1),e+=n(h,c===""?f:c+"."+f),e+=l(h,f)):e+=j(h,f,g,!0);else e+=j(h,f,g,!1),e+=s(h),e+=l(h,f)}}e+=s(b);return e}a=a||{};if(a.escapeMode===void 0)a.escapeMode=!0;a.attributePrefix=a.attributePrefix||"_";a.arrayAccessForm=a.arrayAccessForm||"none";a.emptyNodeForm=a.emptyNodeForm||"text";if(a.enableToStringFunc===void 0)a.enableToStringFunc=!0;a.arrayAccessFormPaths=a.arrayAccessFormPaths||[];if(a.skipEmptyTextNodesForObj===void 0)a.skipEmptyTextNodesForObj=!0;if(a.stripWhitespaces===
void 0)a.stripWhitespaces=!0;a.datetimeAccessFormPaths=a.datetimeAccessFormPaths||[];if(a.useDoubleQuotes===void 0)a.useDoubleQuotes=!1;a.xmlElementsFilter=a.xmlElementsFilter||[];a.jsonPropertiesFilter=a.jsonPropertiesFilter||[];if(a.keepCData===void 0)a.keepCData=!1;var q={ELEMENT_NODE:1,TEXT_NODE:3,CDATA_SECTION_NODE:4,COMMENT_NODE:8,DOCUMENT_NODE:9};this.parseXmlString=function(a){var b=window.ActiveXObject||"ActiveXObject"in window;if(a===void 0)return null;var c;if(window.DOMParser){var d=new window.DOMParser,
...
d=new GeoGlobe.Format.XML,h=0;h<a.length;h++){var j=a[h],l=this._getAttibutionOfNode(j,["cost","price","walkingDistance","transferTimes"]),m=this._parserFeatures(d.write(a[h]));m.attributes=l;j=j.selectNodes("featureMember");for(l=0;l<j.length;l++){var o=j[l].selectNodes("Road");m[l].isOnFoot=o[0].getAttribute("isOnFoot")}c.push(m)}b(c)},failure:c})},_getAttibutionOfNode:function(a,b){var c={};if(a.tagName)for(var d=0;d<b.length;d++)c[b[d]]=a.getAttribute(b[d]);return c},_getGeometryType:function(){return"polygon"},
...
else h.push(b.Contents.Layer);for(var l=0;l<h.length;l++){d={};d.version=b.attributes.version;d.format=h[l].Format[4].text;d.LayerIdentifier=h[l].Identifier.text;d.StyleIdentifier=h[l].Style.Identifier.text;d.MatrixSet=h[l].TileMatrixSetLink[0].TileMatrixSet.text;if(h[l].BoundingBox)d.Bounding=h[l].BoundingBox;for(var m="",j=0;j<b.Contents.TileMatrixSet.length;j++)if(b.Contents.TileMatrixSet[j].Identifier.text==d.MatrixSet)var o=b.Contents.TileMatrixSet[j];d.mapCRS=o.SupportedCRS.text;var p=o.TileMatrix[0];
d.initZoom=p.Identifier.text;if(p.length>0){for(var j=0,s=p.length;j<s;j++){if(j==s)break;m+=p[j].ScaleDenominator.text+","}d.Scales=m.substr(0,m.length-1);d.zoomOffset=p[0].Identifier.text}else if(p)m+=p.ScaleDenominator.text+",",d.Scales=m.substr(0,m.length-1),d.zoomOffset=p.Identifier.text;c[l]=d}a(c,b)},b)},xmlToJson:function(a){var b={};if(a.nodeType==1){if(a.attributes.length>0){b.attributes={};for(var c=0;c<a.attributes.length;c++){var d=a.attributes.item(c);b.attributes[d.nodeName]=d.nodeValue}}}else if(a.nodeType==
...
this._order.splice(this._order.indexOf(a),1);this._order.splice(b?this._order.indexOf(b):this._order.length,0,a);this.render()},_removeInnerLayer:function(a){if(a._meshes&&a._meshes instanceof Array&&a._meshes.length>0)for(var b=0;b<a._meshes.length;b++){for(var c=0;c<this._threebox.world.children.length;c++)if(this._threebox.world.children[c].children.length!==0&&this._threebox.world.children[c].children[0].uuid===a._meshes[b].uuid){this._threebox.world.remove(a._meshes[b].parent);break}for(c=0;c<
this._threebox.world2.children.length;c++)if(this._threebox.world2.children[c].children.length!==0&&this._threebox.world2.children[c].children[0].uuid===a._meshes[b].uuid){this._threebox.world2.remove(a._meshes[b].parent);break}}},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===this.layers[b].id)return this.layers[b]},unprojectFromWorld:function(a){var b=new THREE.Matrix4;b.getInverse(this._threebox.world.matrixWorld);return this._threebox.unprojectFromWorld(a.applyMatrix4(b))},_bindEvent:function(){var a=
...
this.container.offsetTop)/this.container.offsetHeight)*2+1;this._raycaster.setFromCamera(this._raycAsix,this._threebox.camera);return this._raycaster.intersectObjects(this._threebox.scene.children,!0)},_getSymbolObject:function(a){return a.userData.attributes?a:this._getSymbolObject(a.parent)},remove:function(){if(this.container){for(;this.layers.length;)this.removeLayer(this.layers[this.layers.length-1].id);GeoGlobe.Visuals.prototype.remove.apply(this);for(var a in this._listeners)this._listeners.hasOwnProperty(a)&&
...
null},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){var a=this;this._three._removeInnerLayer(this);this._meshes=[];if(a.timer)cancelAnimationFrame(a.timer),a.timer=null;for(var b=[],c=[],d=[],e=[],f=0;f<this.data.length;f++){var g=this.data[f],h=this.getWidth(g),j=new THREE.Color(this.getColor(g)),l=new THREE.LineMaterial({linewidth:5.0E-4*h,color:j,opacity:1,transparent:!0}),m=[],o=[],p=[],s=this.data[f].geometry.coordinates;
if(s.length>1)var n=this._three._threebox.projectToWorld(s[0]),q=this._three._threebox.projectToWorld(s[s.length-1]),q=Math.sqrt(Math.pow(q.x-n.x,2)+Math.pow(q.y-n.y,2)+Math.pow(q.z-n.z,2));for(var t=0;t<s.length-1;t++){var m=this._three._threebox.projectToWorld(s[t]),r=this._three._threebox.projectToWorld(s[t+1]),u={x:(m.x+r.x)/2,y:(m.y+r.y)/2,z:Math.sqrt(Math.pow(r.x-m.x,2)+Math.pow(r.y-m.y,2))/2*Math.tan(Math.PI/2*this.getCurveness(g))},u=new THREE.QuadraticBezierCurve3(new THREE.Vector3(m.x,m.y,
m.z),new THREE.Vector3(u.x,u.y,u.z),new THREE.Vector3(r.x,r.y,r.z));if(s.length>1)u.rate1=Math.sqrt(Math.pow(m.x-n.x,2)+Math.pow(m.y-n.y,2)+Math.pow(m.z-n.z,2))/q,u.rate2=Math.sqrt(Math.pow(r.x-m.x,2)+Math.pow(r.y-m.y,2)+Math.pow(r.z-m.z,2))/q;p.push(u);m=u.getPoints(50);for(r=0;r<m.length;r++)o.push(m[r].x,m[r].y,m[r].z)}s=new THREE.LineGeometry;s.setPositions(o);l=new THREE.Line2(s,l);l.computeLineDistances();l.visible=this.visible;l.name=(this.id?this.id:"threelayer")+"-"+f;l.userData.attributes=
{OriginalData:g,Layer:this};this._three._threebox.addGeoreferencedMesh(l);this._meshes.push(l);b.push(o[0]);b.push(o[1]);b.push(o[2]);c.push(j.r,j.g,j.b);d.push(10+h*h);e.push(p)}var v=new THREE.BufferGeometry,f=new THREE.ShaderMaterial({uniforms:{texture:{value:(new THREE.TextureLoader).load(this.texture)}},vertexShader:"attribute float size;varying vec3 vColor;void main() {vColor = color;vec4 mvPosition = modelViewMatrix * vec4( position, 1.0 );gl_PointSize = size;gl_Position = projectionMatrix * mvPosition;}",
...
this.specificFloorColorOpacity;this.specificWallColorOpacity=a.specificWallColorOpacity?a.specificWallColorOpacity:this.specificWallColorOpacity;this.data=a.data?a.data:this.data;this.isClicked=!0;this.getColor=a.getColor?a.getColor:this.getColor;this.getPolygon=a.getPolygon?a.getPolygon:this.getPolygon;this.getElevation=a.getElevation?a.getElevation:this.getElevation;this.getBaseElevation=a.getBaseElevation?a.getBaseElevation:this.getBaseElevation;this.timer=null}else console.error("\u672a\u5f15\u5165turf.js\u5e93\uff01")},
...
"__floor__"){b=a[c].object;break}return b},render:function(){function a(c,d){d>1E3/60&&(B<1?(x.position.copy(C.getPointAt(B)),B+=0.01):B=0,b._three._render(),d=0);b.timer=window.requestAnimationFrame(function(b){return a(b,d+b-c)})}var b=this;b._three._removeInnerLayer(b);b._meshes=[];if(b.timer)cancelAnimationFrame(b.timer),b.timer=null;var c=new THREE.Group;c.visible=this.visible;c.name="main part";c.userData.attributes={OriginalData:b.data,Layer:b};var d=new THREE.Group;d.visible=this.visible;
d.name="extra part";d.userData.attributes={OriginalData:b.data,Layer:b};if(b.data.geometry){var e=turf.centroid(b.data).geometry.coordinates;if(b.isCirclesVisible){var f=new THREE.MeshBasicMaterial({color:7372944,transparent:!0,opacity:0.3});[0.01,0.015,0.02,0.025,0.03,0.035,0.04,0.045,0.05,0.055].forEach(function(a){var a=turf.circle(e,a,{steps:50,units:"kilometers",properties:{}}),d=new THREE.Geometry;a.geometry.coordinates[0].forEach(function(a){d.vertices.push(b._three._threebox.projectToWorld([a[0],
a[1],-1]))});a=new THREE.Line(d,f);c.add(a)})}var g=b.data.geometry.coordinates[0],h=0,j=JSON.parse(b.data.properties.levels);j.forEach(function(a){h+=a});for(var l=b._three._threebox.distaneToWorld(h),m={steps:10,units:"kilometers",properties:{}},o=[],p=[],s=[],n=[],q=[],t=[],r=0;r<g.length;r++){var u=[],v=b._three._threebox.projectToWorld(g[r]);p.push(v.clone());var w=v.clone();w.z=l;s.push(w.clone());u.push(v.clone());u.push(w.clone());n.push(u);q.push(v.clone());t.push(v.clone());u=turf.circle(g[r],
2.0E-4,m);o.push(u)}g=new THREE.MeshPhongMaterial({color:16777215,transparent:!0,opacity:1});new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.5});p=b._createLineGeometry(p);m=b._createLineGeometry(s);s=p.clone();p=new THREE.Line(p,g);p.name="linebase";m=new THREE.Line(m,g);m.name="lineUp";c.add(p);c.add(m);l={pillar:{amount:l,bevelEnabled:!1},floor:{amount:1.0E-12,bevelEnabled:!1}};o=b._createPillarMesh(o,l.pillar,g);o.name="pillar";c.add(o);o=new THREE.MeshPhongMaterial({color:6454209,
transparent:!0,opacity:0.5});q=b._createGeoExtrudeGeometry(q,l.floor);for(p=l=0;p<j.length;p++)g=b._three._threebox.distaneToWorld(l),n=new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.1,specular:6454209,shininess:100}),m=new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.05,specular:16776960,shininess:100,side:THREE.DoubleSide}),r=q.clone(),r.translate(0,0,g),n=new THREE.Mesh(r,n),n.userData.attributes={OriginalData:b.data,Layer:b,level:p+1,tag:"__floor__"},n.userData.tag=
"__floor__",n.name="this is "+(p+1)+" floor",c.add(n),b.isFloorLinesVisible&&(n=s.clone(),n.translate(0,0,g),n=new THREE.Line(n,o),c.add(n)),n={amount:b._three._threebox.distaneToWorld(j[p]),bevelEnabled:!1},n=b._createSideGeometry(t,n),n.translate(0,0,g),g=new THREE.Mesh(n,m),g.userData.attributes={OriginalData:b.data,Layer:b,level:p+1,tag:"__wall__"},g.userData.tag="__wall__",g.name="this is "+(p+1)+" wall",c.add(g),l+=j[p];var j=new THREE.MeshBasicMaterial({color:16777215,transparent:!0,opacity:1}),
t=new THREE.SphereBufferGeometry(0.001,32,16),x=new THREE.Mesh(t,j);x.position.copy(b._three._threebox.projectToWorld([e[0],e[1],0]));x.name="sphereTarget";x.scale.copy((new THREE.Vector3(1,1,1)).multiplyScalar(b._three._threebox.projectedUnitsPerMeterInScale(e[1])));b.lightShown&&d.add(x);j=new THREE.PointLight(new THREE.Color(b.lightColor),200,0);j.matrixWorldNeedsUpdate=!0;x.add(j);b._three._threebox.addGeoreferencedMeshToWorld2(c);b._meshes.push(c);b._three._threebox.addGeoreferencedMesh(d);b._meshes.push(d);
var d=b._three._threebox.projectToWorld([e[0],e[1],h]),j=b._three._threebox.projectToWorld([e[0],e[1],0]),C=new THREE.LineCurve3(j,d),B=0;b.lightShown&&window.requestAnimationFrame(function(b){return a(b,0)})}}});
...
a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a},identity:function(a){a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a},translate:function(a,b,c){var d=c[0],e=c[1],c=c[2],f,g,h,j,l,m,o,p,s,n,q,t;b===a?(a[12]=b[0]*d+b[4]*e+b[8]*c+b[12],a[13]=b[1]*d+b[5]*e+b[9]*c+b[13],a[14]=b[2]*d+b[6]*e+b[10]*c+b[14],a[15]=b[3]*d+b[7]*e+b[11]*c+b[15]):(f=b[0],
g=b[1],h=b[2],j=b[3],l=b[4],m=b[5],o=b[6],p=b[7],s=b[8],n=b[9],q=b[10],t=b[11],a[0]=f,a[1]=g,a[2]=h,a[3]=j,a[4]=l,a[5]=m,a[6]=o,a[7]=p,a[8]=s,a[9]=n,a[10]=q,a[11]=t,a[12]=f*d+l*e+s*c+b[12],a[13]=g*d+m*e+n*c+b[13],a[14]=h*d+o*e+q*c+b[14],a[15]=j*d+p*e+t*c+b[15]);return a},scale:function(a,b,c){var d=c[0],e=c[1],c=c[2];a[0]=b[0]*d;a[1]=b[1]*d;a[2]=b[2]*d;a[3]=b[3]*d;a[4]=b[4]*e;a[5]=b[5]*e;a[6]=b[6]*e;a[7]=b[7]*e;a[8]=b[8]*c;a[9]=b[9]*c;a[10]=b[10]*c;a[11]=b[11]*c;a[12]=b[12];a[13]=b[13];a[14]=b[14];
a[15]=b[15];return a},multiply:function(a,b,c){var d=b[0],e=b[1],f=b[2],g=b[3],h=b[4],j=b[5],l=b[6],m=b[7],o=b[8],p=b[9],s=b[10],n=b[11],q=b[12],t=b[13],r=b[14],b=b[15],u=c[0],v=c[1],w=c[2],x=c[3];a[0]=u*d+v*h+w*o+x*q;a[1]=u*e+v*j+w*p+x*t;a[2]=u*f+v*l+w*s+x*r;a[3]=u*g+v*m+w*n+x*b;u=c[4];v=c[5];w=c[6];x=c[7];a[4]=u*d+v*h+w*o+x*q;a[5]=u*e+v*j+w*p+x*t;a[6]=u*f+v*l+w*s+x*r;a[7]=u*g+v*m+w*n+x*b;u=c[8];v=c[9];w=c[10];x=c[11];a[8]=u*d+v*h+w*o+x*q;a[9]=u*e+v*j+w*p+x*t;a[10]=u*f+v*l+w*s+x*r;a[11]=u*g+v*m+
w*n+x*b;u=c[12];v=c[13];w=c[14];x=c[15];a[12]=u*d+v*h+w*o+x*q;a[13]=u*e+v*j+w*p+x*t;a[14]=u*f+v*l+w*s+x*r;a[15]=u*g+v*m+w*n+x*b;return a},perspective:function(a,b,c,d,e){var b=1/Math.tan(b/2),f=1/(d-e);a[0]=b/c;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=b;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=(e+d)*f;a[11]=-1;a[12]=0;a[13]=0;a[14]=2*e*d*f;a[15]=0;return a},rotateX:function(a,b,c){var d=Math.sin(c),c=Math.cos(c),e=b[4],f=b[5],g=b[6],h=b[7],j=b[8],l=b[9],m=b[10],o=b[11];b!==a&&(a[0]=b[0],a[1]=b[1],a[2]=b[2],a[3]=
b[3],a[12]=b[12],a[13]=b[13],a[14]=b[14],a[15]=b[15]);a[4]=e*c+j*d;a[5]=f*c+l*d;a[6]=g*c+m*d;a[7]=h*c+o*d;a[8]=j*c-e*d;a[9]=l*c-f*d;a[10]=m*c-g*d;a[11]=o*c-h*d;return a},rotateZ:function(a,b,c){var d=Math.sin(c),c=Math.cos(c),e=b[0],f=b[1],g=b[2],h=b[3],j=b[4],l=b[5],m=b[6],o=b[7];b!==a&&(a[8]=b[8],a[9]=b[9],a[10]=b[10],a[11]=b[11],a[12]=b[12],a[13]=b[13],a[14]=b[14],a[15]=b[15]);a[0]=e*c+j*d;a[1]=f*c+l*d;a[2]=g*c+m*d;a[3]=h*c+o*d;a[4]=j*c-e*d;a[5]=l*c-f*d;a[6]=m*c-g*d;a[7]=o*c-h*d;return a},invert:function(a,
b){var c=b[0],d=b[1],e=b[2],f=b[3],g=b[4],h=b[5],j=b[6],l=b[7],m=b[8],o=b[9],p=b[10],s=b[11],n=b[12],q=b[13],t=b[14],r=b[15],u=c*h-d*g,v=c*j-e*g,w=c*l-f*g,x=d*j-e*h,C=d*l-f*h,B=e*l-f*j,A=m*q-o*n,z=m*t-p*n,y=m*r-s*n,E=o*t-p*q,F=o*r-s*q,G=p*r-s*t,D=u*G-v*F+w*E+x*y-C*z+B*A;if(!D)return null;D=1/D;a[0]=(h*G-j*F+l*E)*D;a[1]=(e*F-d*G-f*E)*D;a[2]=(q*B-t*C+r*x)*D;a[3]=(p*C-o*B-s*x)*D;a[4]=(j*y-g*G-l*z)*D;a[5]=(c*G-e*y+f*z)*D;a[6]=(t*w-n*B-r*v)*D;a[7]=(m*B-p*w+s*v)*D;a[8]=(g*F-h*y+l*A)*D;a[9]=(d*y-c*F-f*A)*
D;a[10]=(n*C-q*w+r*u)*D;a[11]=(o*w-m*C-s*u)*D;a[12]=(h*z-g*E-j*A)*D;a[13]=(c*E-d*z+e*A)*D;a[14]=(q*v-n*x-t*u)*D;a[15]=(m*x-o*v+p*u)*D;return a},ortho:function(a,b,c,d,e,f,g){var h=1/(b-c),j=1/(d-e),l=1/(f-g);a[0]=-2*h;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=-2*j;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=2*l;a[11]=0;a[12]=(b+c)*h;a[13]=(e+d)*j;a[14]=(g+f)*l;a[15]=1;return a}}}});
...
e;this.value=h;this.lon=j;this.lat=l;this.attributes=m;this.init();this.weight=(this.value-a.minValue)/(a.maxValue-a.minValue);if(isNaN(this.weight))this.weight=1;if(this.weight>1)this.weight=1;if(this.weight<0)this.weight=0;this.size=b.symbolMinSize+(b.symbolMaxSize-b.symbolMinSize)*this.weight;this.radius=this.size/2;if(d.flat)this.color=GeoGlobe.Util.getType(d.color)==="object"?"rgba("+a.gradientImageData[~~(this.weight*255+0.5)*4]+","+a.gradientImageData[~~(this.weight*255+0.5)*4+1]+","+a.gradientImageData[~~(this.weight*
...
this.radius*Math.sin(Math.PI/3),this.y-this.radius-this.radius*Math.sin(Math.PI/6));c.arc(this.x,this.y-this.radius*2,this.radius,0,Math.PI*5/6,!0);c.arc(this.x,this.y-this.radius*2,this.radius,0,Math.PI/6,!1);c.quadraticCurveTo(this.x,this.y-this.radius/2,this.x+0.5,this.y);break;case "rmb":c.font=e.fontStyle+" "+e.fontWeight+" "+this.size+"px "+e.fontFamily;if(GeoGlobe.String.isNumeric(this.value)){var j=0,l=this.size;if(b.formatter)for(var m=GeoGlobe.Util.getFormattedString({a:this.name,b:"\u7edf\u8ba1\u6570",
c:this.value},b.formatter).split("<br/>"),o=m.length,p=0;p<o;p++){var s=c.measureText(m[p]).width;s>j&&(j=s);c.fillText(m[p],this.x,this.y-((o-1)/2-p)*(this.radius*2+5))}else j=c.measureText("\uffe5"+this.value).width;c.rect(this.x-j/2,this.y-l/2,j,l)}break;case "fire":c.rect(this.x-this.size/2,this.y-this.size/2,this.size,this.size);break;case "icon":c.rect(this.x-b.symbolWidth/2,this.y-b.symbolHeight/2,b.symbolWidth,b.symbolHeight)}if(c.isPointInPath(d,h))a.hoveredMarkPoint=this};this.MarkPoint.prototype.draw1=
...
e.fill();break;case "water":h=this.x-this.radius*0.8;j=this.y;var l,m;e.beginPath();e.moveTo(h,j);for(g=-this.waveLength;g<=this.waveLength;g+=0.01)g=parseFloat(parseFloat(g).toFixed(2)),l=h+this.waveSize*((g+this.waveLength)/(this.waveLength*2)),m=j+this.noises[0]*Math.pow(Math.sin(g*10*this.attenuations[0]),1)*Math.sin(this.Fs[0]*g-this.energy),e.lineTo(l,m);e.arc(this.x,this.y,this.radius*0.8,0,Math.PI,!1);e.fillStyle=GeoGlobe.Util.getShadeColor(this.color,-10);e.globalAlpha=this.alpha;e.fill();
...
this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.div.style.display=a?"block":"none";a?this.draw():this.stopDraw()},setData:function(a){this.data=a;this.minValue=Number.MAX_VALUE;this.maxValue=Number.MIN_VALUE;for(var b=0;b<
a.length;b++){if(a[b].properties[this._rendererOptions.markPoint.valueField]<this.minValue)this.minValue=a[b].properties[this._rendererOptions.markPoint.valueField];if(a[b].properties[this._rendererOptions.markPoint.valueField]>this.maxValue)this.maxValue=a[b].properties[this._rendererOptions.markPoint.valueField]}this.maxValue/=this._rendererOptions.markPoint.symbolValueRangeScale;for(var c=[],b=0;b<a.length;b++)c.push(new this.MarkPoint(b,a[b].properties[this._rendererOptions.markPoint.nameField],
a[b].properties[this._rendererOptions.markPoint.valueField],a[b].geometry.coordinates[0],a[b].geometry.coordinates[1],a[b].properties));this.hoveredMarkPoint=null;this.markPoints=c}});
...
"none"},_init_RendererOptions:function(){this._rendererOptions=GeoGlobe.Util.deepExtend({},{markLine:{hoverable:!0,curveness:0.6,effect:{color:"#fff",scaleSize:3,period:30},itemStyle:{color:null,width:1,dash:[]}},markPoint:{nameField:"name",valueField:"value",hoverable:!0,symbol:"emptyCircle",symbolMinSize:20,symbolMaxSize:40,effect:{scaleSize:2,period:30},itemStyle:{color:"rgba(255,0,0,0.5)",shadowColor:"#000000",shadowBlur:0,shadowOffsetX:0,shadowOffsetY:0},label:{show:!0,color:"#fff",align:"center",
baseline:"middle",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}},tooltip:{show:!0,backgroundColor:"#fff",borderColor:"#333",borderRadius:0,borderWidth:0,padding:10,textStyle:{color:"#000",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},this.rendererOptions)},_initMarkPoint:function(){var a=this,b=this._rendererOptions.markPoint.symbol,c=this._rendererOptions.markPoint.symbolMinSize,d=this._rendererOptions.markPoint.symbolMaxSize,e=this._rendererOptions.markPoint.effect,
f=this._rendererOptions.markPoint.itemStyle;if(typeof f.color==="object")var g=GeoGlobe.Util.getGradientImageData(f.color);var h=this._rendererOptions.markPoint.label;this.MarkPoint=function(b,e,h,o,p){this.index=b;this.name=e;this.value=h;this.lon=o;this.lat=p;this.init();this.weight=(this.value-a.minValue)/(a.maxValue-a.minValue);if(isNaN(this.weight))this.weight=1;if(this.weight>1)this.weight=1;if(this.weight<0)this.weight=0;this.size=c+(d-c)*this.weight;this.radius=this.size/2;this.color=typeof f.color===
"object"?"rgba("+g[parseInt(this.weight*255,10)*4]+","+g[parseInt(this.weight*255,10)*4+1]+","+g[parseInt(this.weight*255,10)*4+2]+","+g[3]/255+")":f.color;this.rgbColor=GeoGlobe.Util.getRgbColor(this.color);this.tmpColor=this.color};this.MarkPoint.prototype.init=function(){switch(b){case "circle":this.energy=[0,1/3,2/3];break;case "ring":this.energy=[0,0.25*e.scaleSize,0.5*e.scaleSize,0.75*e.scaleSize];break;case "emptyCircle":this.energy=0}this.increment=Math.max(0.1*e.scaleSize/e.period+Math.random()*
(Math.random()>0.5?1:-1)*0.002,0.001)};this.MarkPoint.prototype.updateXY=function(){var b=a._parent.map.project([this.lon,this.lat]);this.x=b.x;this.y=b.y};this.MarkPoint.prototype.update=function(){var a;switch(b){case "circle":for(a=0;a<3;a++)this.energy[a]<1?this.energy[a]+=this.increment:this.energy[a]=0;break;case "ring":for(a=0;a<4;a++)this.energy[a]<e.scaleSize?this.energy[a]+=this.increment:this.energy[a]=0;break;case "emptyCircle":this.energy<e.scaleSize?this.energy+=this.increment:this.energy=
0}};this.MarkPoint.prototype.isPointInPath=function(b,c,d){b.beginPath();b.arc(this.x,this.y,this.size/2,0,Math.PI*2,!0);if(b.isPointInPath(c,d))a.hoveredMarkPoint=this};this.MarkPoint.prototype.draw1=function(c){a.hoveredMarkPoint===this?(this.radius=this.size/2*1.1,this.color=GeoGlobe.Util.getShadeColor(this.tmpColor,20)):(this.radius=this.size/2,this.color=this.tmpColor);this.rgbColor=GeoGlobe.Util.getRgbColor(this.color);c.shadowColor=f.shadowColor;c.shadowBlur=f.shadowBlur;c.shadowOffsetX=f.shadowOffsetX;
c.shadowOffsetY=f.shadowOffsetY;switch(b){case "circle":c.beginPath();c.arc(this.x,this.y,this.radius,0,Math.PI*2,!0);c.fillStyle=this.color;c.fill();break;case "emptyCircle":if(a.hoveredMarkPoint===this)c.beginPath(),c.arc(this.x,this.y,this.radius*e.scaleSize/2,0,Math.PI*2,!0),c.lineWidth=Math.round(this.radius/5)<2?2:Math.round(this.radius/5),c.strokeStyle=this.color,c.stroke()}};this.MarkPoint.prototype.draw2=function(a){this.update();var c;switch(b){case "circle":for(c=0;c<3;)a.beginPath(),a.arc(this.x,
this.y,this.radius+this.radius*(e.scaleSize-1)*this.energy[c],0,Math.PI*2,!0),a.strokeStyle="rgba"+this.rgbColor.slice(3).split(")")[0]+","+(1-this.energy[c])+")",a.stroke(),c++;break;case "ring":for(c=0;c<4;)a.beginPath(),a.arc(this.x,this.y,this.radius*this.energy[c],0,Math.PI*2,!0),a.fillStyle="rgba"+this.rgbColor.slice(3).split(")")[0]+","+Math.max(1-this.energy[c]/e.scaleSize,0)+")",a.fill(),c++;break;case "emptyCircle":a.beginPath(),a.arc(this.x,this.y,this.radius*this.energy,0,Math.PI*2,!0),
a.strokeStyle=this.color,a.stroke()}if(h.show)a.font=h.fontStyle+" "+h.fontWeight+" "+h.fontSize+"px "+h.fontFamily,a.textAlign=h.align,a.textBaseline=h.baseline,a.fillStyle=h.color?h.color:this.color,a.fillText(this.value,this.x,this.y)}},_initMarkLine:function(){var a=this,b=this._rendererOptions.markLine.effect,c=this._rendererOptions.markLine.itemStyle;this.MarkLine=function(d,e,f){var g=this;this.index=d;this.start=e;this.end=f;this.color=c.color?c.color:a.direction==="out"?f.color:e.color;this.width=
c.width;this.dash=c.dash;this.effect={radius:c.width*b.scaleSize/2,color:b.color,increment:0.1/b.period,init:function(){this.energy=0},update:function(){this.energy<1?(this.energy+=this.increment,a._rendererOptions.markLine.curveness!==0?(this.x=Math.pow(1-this.energy,2)*g.p1.x+2*this.energy*(1-this.energy)*g.cp.x+Math.pow(this.energy,2)*g.p2.x,this.y=Math.pow(1-this.energy,2)*g.p1.y+2*this.energy*(1-this.energy)*g.cp.y+Math.pow(this.energy,2)*g.p2.y):(this.x=g.p1.x+this.energy*(g.p2.x-g.p1.x),this.y=
g.p1.y+this.energy*(g.p2.y-g.p1.y))):this.init()},draw:function(a){this.update();a.beginPath();a.arc(this.x,this.y,this.radius,0,Math.PI*2,!0);a.fillStyle=this.color;a.fill();a.closePath()}}};this.MarkLine.prototype.updateXY=function(){this.p1=a._parent.map.project([this.start.lon,this.start.lat]);this.p2=a._parent.map.project([this.end.lon,this.end.lat]);a._rendererOptions.markLine.curveness!==0&&this.getControlPoint()};this.MarkLine.prototype.getControlPoint=function(){var b=a._rendererOptions.markLine.curveness/
2,c=Math.sqrt(Math.pow(this.p1.x-this.p2.x,2)+Math.pow(this.p1.y-this.p2.y,2)),f=c/2/Math.cos(b);this.p1.x===this.p2.x?this.cp=this.p1.y>this.p2.y?{x:this.p1.x-Math.round(f*Math.sin(b)),y:this.p1.y-Math.round(f*Math.cos(b))}:this.p1.y===this.p2.y?{x:this.p1.x,y:this.p1.y}:{x:this.p1.x+Math.round(f*Math.sin(b)),y:this.p1.y+Math.round(f*Math.cos(b))}:this.p1.x<this.p2.x?this.p1.y>this.p2.y?(c=Math.asin((this.p2.x-this.p1.x)/c),this.cp=c<b?{x:this.p1.x-Math.round(f*Math.sin(b-c)),y:this.p1.y-Math.round(f*
Math.cos(b-c))}:c===b?{x:this.p1.x,y:this.p1.y-f}:{x:this.p1.x+Math.round(f*Math.sin(c-b)),y:this.p1.y-Math.round(f*Math.cos(c-b))}):this.p1.y===this.p2.y?this.cp={x:this.p1.x+Math.round(f*Math.cos(b)),y:this.p1.y-Math.round(f*Math.sin(b))}:(c=Math.PI-Math.asin((this.p2.x-this.p1.x)/c),this.cp=c<Math.PI/2+b?{x:this.p1.x+Math.round(f*Math.cos(b-(c-Math.PI/2))),y:this.p1.y-Math.round(f*Math.sin(b-(c-Math.PI/2)))}:c===Math.PI/2+b?{x:this.p1.x+f,y:this.p1.y}:{x:this.p1.x+Math.round(f*Math.cos(c-Math.PI/
2-b)),y:this.p1.y+Math.round(f*Math.sin(c-Math.PI/2-b))}):this.p1.y<this.p2.y?(c=Math.PI+Math.asin((this.p1.x-this.p2.x)/c),this.cp=c<Math.PI+b?{x:this.p1.x+Math.round(f*Math.sin(b-(c-Math.PI))),y:this.p1.y+Math.round(f*Math.cos(b-(c-Math.PI)))}:c===Math.PI+b?{x:this.p1.x,y:this.p1.y+f}:{x:this.p1.x-Math.round(f*Math.sin(c-Math.PI-b)),y:this.p1.y+Math.round(f*Math.cos(c-Math.PI-b))}):this.p1.y===this.p2.y?this.cp={x:this.p1.x-Math.round(f*Math.cos(b)),y:this.p1.y+Math.round(f*Math.sin(b))}:(c=Math.PI*
3/2+Math.acos((this.p1.x-this.p2.x)/c),this.cp=c<Math.PI*3/2+b?{x:this.p1.x-Math.round(f*Math.cos(b-(c-Math.PI*3/2))),y:this.p1.y+Math.round(f*Math.sin(b-(c-Math.PI*3/2)))}:c===Math.PI*3/2+b?{x:this.p1.x-f,y:this.p1.y}:{x:this.p1.x-Math.round(f*Math.cos(c-Math.PI*3/2-b)),y:this.p1.y-Math.round(f*Math.sin(c-Math.PI*3/2-b))})};this.MarkLine.prototype.isPointInStroke=function(b,c,f){b.beginPath();b.moveTo(this.p1.x,this.p1.y);a._rendererOptions.markLine.curveness!==0?b.quadraticCurveTo(this.cp.x,this.cp.y,
this.p2.x,this.p2.y):b.lineTo(this.p2.x,this.p2.y);if(b.isPointInStroke(c,f))a.hoveredMarkLine=this};this.MarkLine.prototype.draw=function(b){a.hoveredMarkLine===this?(this.color=GeoGlobe.Util.getShadeColor(c.color?c.color:a.direction==="out"?this.end.color:this.start.color,20),this.width=c.width*1.1,this.dash=c.dash.map(function(a){return a*1.1})):(this.color=c.color?c.color:a.direction==="out"?this.end.color:this.start.color,this.dash=c.dash);b.beginPath();b.moveTo(this.p1.x,this.p1.y);a._rendererOptions.markLine.curveness!==
0?b.quadraticCurveTo(this.cp.x,this.cp.y,this.p2.x,this.p2.y):b.lineTo(this.p2.x,this.p2.y);b.setLineDash(this.dash);b.lineWidth=this.width;b.strokeStyle=this.color;b.stroke()}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvas.push(document.createElement("canvas"));this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.canvasContext.push(this.canvas[1].getContext("2d"));
this.canvasContext.push(this.canvas[2].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.cacheCanvasContext.push(this.cacheCanvas[1].getContext("2d"));this.cacheCanvasContext.push(this.cacheCanvas[2].getContext("2d"));this.canvas[0].style.position=
"absolute";this.canvas[1].style.position="absolute";this.canvas[2].style.position="absolute";this.div.appendChild(this.canvas[0]);this.div.appendChild(this.canvas[1]);this.div.appendChild(this.canvas[2])},_initTooltip:function(){if((this._rendererOptions.markLine.hoverable||this._rendererOptions.markPoint.hoverable)&&this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this.div.appendChild(document.createElement("div")),this.tooltipDiv.style.position="relative",this.tooltipDiv.style.display=
...
this.tooltipDiv.style.transition="left 0.4s cubic-bezier(0.23, 1, 0.32, 1), top 0.4s cubic-bezier(0.23, 1, 0.32, 1)"},render:function(){this._init_RendererOptions();this._initMarkPoint();this._initMarkLine();this._initTooltip();this.setData(this.data);this.draw()},draw:function(){this.updateXY();this.drawCanvas1();this.animation=!0;this.frame&&cancelAnimationFrame(this.frame);var a=this;(function c(){a.frame=requestAnimationFrame(c);a.animation&&a.drawCanvas2();a.animation&&a.drawCanvas3();a.animation=
!0})()},onMove:function(){this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width;this.animation=!1;this.updateXY();this.drawCanvas1();this.drawCanvas2();this.drawCanvas3()},onMoveEnd:function(){this.redraw()},onMouseMove:function(a){if(this.visibility&&(this._rendererOptions.markLine.hoverable||this._rendererOptions.markPoint.hoverable)&&this.markPoints.length>0&&!this._parent.map.moving)this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,
feature:this.hoveredMarkPoint,event:a})},onResize:function(){this.canvas[0].width=this.canvas[1].width=this.canvas[2].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.canvas[2].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.cacheCanvas[2].height=this.height=this._parent.map.transform.height;this.redraw()},redraw:function(){this.clearCanvas();this.updateXY();
this.drawCanvas1();this.drawCanvas2();this.drawCanvas3()},updateXY:function(){for(var a=this.markPoints.length;a--;)this.markPoints[a].updateXY(),this.markLines[a].updateXY()},drawCanvas1:function(){this.cacheCanvas[0].width=this.width;for(var a=this.markLines.length;a--;)this.markLines[a].draw(this.cacheCanvasContext[0]);for(a=this.markPoints.length;a--;)this.markPoints[a].draw1(this.cacheCanvasContext[0]);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},
drawCanvas2:function(){document.createElement("canvas").getContext?(this.cacheCanvasContext[1].globalCompositeOperation="destination-out",this.cacheCanvasContext[1].fillStyle="rgba(0, 0, 0, 0.05)",this.cacheCanvasContext[1].fillRect(0,0,this.width,this.height),this.cacheCanvasContext[1].globalCompositeOperation="source-over"):this.cacheCanvas[1].width=this.width;this.cacheCanvasContext[1].save();for(var a=this.markLines.length;a--;)this.markLines[a].effect.draw(this.cacheCanvasContext[1]);this.cacheCanvasContext[1].restore();
this.canvas[1].width=this.width;this.canvasContext[1].drawImage(this.cacheCanvas[1],0,0)},drawCanvas3:function(){this._rendererOptions.markPoint.symbol==="emptyCircle"?document.createElement("canvas").getContext?(this.cacheCanvasContext[2].globalCompositeOperation="destination-out",this.cacheCanvasContext[2].fillStyle="rgba(0, 0, 0, 0.05)",this.cacheCanvasContext[2].fillRect(0,0,this.width,this.height),this.cacheCanvasContext[2].globalCompositeOperation="source-over"):this.cacheCanvas[2].width=this.width:
this._rendererOptions.markPoint.symbol==="ring"?(this.cacheCanvas[2].width=this.width,this.cacheCanvasContext[2].globalCompositeOperation="lighter"):this.cacheCanvas[2].width=this.width;this.cacheCanvasContext[2].save();for(var a=this.markPoints.length;a--;)this.markPoints[a].draw2(this.cacheCanvasContext[2]);this.cacheCanvasContext[2].restore();this.canvas[2].width=this.width;this.canvasContext[2].drawImage(this.cacheCanvas[2],0,0)},clearCanvas:function(){this.canvas[0].width=this.canvas[1].width=
this.canvas[2].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width},stopDraw:function(){cancelAnimationFrame(this.frame);this.clearCanvas()},destroy:function(){this.stopDraw();this._parent.container.removeChild(this.div);this.MarkPoint=null;this.markPoints=[];this.canvas=[];this.data=[];this.cacheCanvas=[];this.canvasContext=[];this.cacheCanvasContext=[];this._rendererOptions={}},hover:function(a,b){this.hoveredMarkLine=null;this.lastHoveredMarkPoint=this.hoveredMarkPoint?
GeoGlobe.Util.clone(this.hoveredMarkPoint):null;this.hoveredMarkPoint=null;var c,d;c=0;for(d=this.markLines.length;c<d;c++)!this.hoveredMarkLine&&this.markLines[c].isPointInStroke(this.cacheCanvasContext[0],a,b);c=0;for(d=this.markPoints.length;c<d;c++)!this.hoveredMarkPoint&&this.markPoints[c].isPointInPath(this.cacheCanvasContext[0],a,b);this.drawCanvas1();this.hoveredMarkLine||this.hoveredMarkPoint?(this.showTooltip(this.hoveredMarkLine?this.hoveredMarkLine.start.name+" > "+this.hoveredMarkLine.end.name:
this.hoveredMarkPoint.name,a,b),this.canvas[2].style.cursor="pointer"):(this.hideTooltip(),this.canvas[2].style.cursor="grab")},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);
this.canvas[0].width=this.canvas[1].width=this.canvas[2].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.canvas[2].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.cacheCanvas[2].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.div.style.display=a?"block":"none";a?this.draw():this.stopDraw()},setData:function(a){this.data=
a;this.minValue=Number.MAX_VALUE;this.maxValue=Number.MIN_VALUE;for(var b=0;b<a.length;b++){if(a[b].properties[this._rendererOptions.markPoint.valueField]<this.minValue)this.minValue=a[b].properties[this._rendererOptions.markPoint.valueField];if(a[b].properties[this._rendererOptions.markPoint.valueField]>this.maxValue)this.maxValue=a[b].properties[this._rendererOptions.markPoint.valueField]}for(var c=new this.MarkPoint(void 0,this.location.name,0,this.location.lonLat[0],this.location.lonLat[1]),d=
[],e=[],b=0;b<a.length;b++)d.push(new this.MarkPoint(b,a[b].properties[this._rendererOptions.markPoint.nameField],a[b].properties[this._rendererOptions.markPoint.valueField],a[b].geometry.coordinates[0],a[b].geometry.coordinates[1])),e.push(this.direction==="out"?new this.MarkLine(b,c,d[b]):new this.MarkLine(b,d[b],c));this.hoveredMarkLine=this.hoveredMarkPoint=null;this.markPoints=d;this.markLines=e}});
...
255+0.5)*4]+","+a.gradientImageData[~~(d[c].weight*255+0.5)*4+1]+","+a.gradientImageData[~~(d[c].weight*255+0.5)*4+2]+","+a.gradientImageData[3]/255+")":b[e]}};this.MarkPointsSet.prototype.updateXY=function(){for(var b=this.markPoints.length;b--;){var c=a._parent.map.project([this.markPoints[b].lon,this.markPoints[b].lat]);this.markPoints[b].x=c.x;this.markPoints[b].y=c.y}};this.MarkPointsSet.prototype.draw=function(a,b){if(d||c[b]!==0){var g=[],m=function(a){for(var b=0;b<g.length;b++)if(parseInt(g[b].x)===
parseInt(a.x)&&parseInt(g[b].y)===parseInt(a.y))return g[b];return null},o=function(){a.fillStyle=s.color;a.beginPath();switch(e){case "square":a.globalCompositeOperation="lighter";a.rect(s.x-f/2,s.y-f/2,f,f);break;case "square2":a.rect(s.x-f/2,s.y-f/2,f,f);break;case "round":a.globalCompositeOperation="lighter",a.arc(s.x,s.y,f/2,0,Math.PI*2,!1)}a.fill()},p=this.markPoints.length;for(this.markPoints=this.markPoints.sort(function(a,b){var c=a.value,d=b.value;return c>d?-1:c<d?1:0});p--;){var s;s=this.markPoints[p];
if(e==="square2"){var n=m(s);if(n){if(s.value>n.value)o(),n.value=s.value}else o(),g.push({x:s.x,y:s.y,value:s.value})}else o()}}}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].style.position="absolute";
...
this._legend.itemSize)+10)*(~~(this.legendLabels.length/this._legend.col)+(this.legendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=h;this.legendCanvas.height=c;var j=function(a,c,d,e){this.legendCanvas.width=h;for(var f=!1,g,j,t=0,a=a!==void 0?a+1:this.legendLabels.length;t<a;t++){j=0;for(var r=this._legend.col;j<r;j++)if(t%this._legend.col===j){g=10+this._legend.itemSize/2;for(var u=0;u<j;u++)g+=b[u]+10}j=10+this._legend.itemSize/2+((this._legend.itemSize<this._legend.textStyle.fontSize?
this._legend.textStyle.fontSize:this._legend.itemSize)+10)*~~(t/this._legend.col);u=r=!1;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "square2":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "round":this.legendCanvasContext.arc(g,
j,this._legend.itemSize/2,0,Math.PI*2,!1)}c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=r=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(g+this._legend.itemSize/2+10,
j-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this.legendLabels[t].toString()).width,this._legend.textStyle.fontSize);c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=r=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);u&&(this._legend.itemStatuses[t]=this._legend.itemStatuses[t]===0?1:0,this.drawCanvas());var v=this._legend.itemStatuses[t]===0?"#808080":this._legend.itemColors[t]?this._legend.itemColors[t]:
this._rendererOptions.markPoint.itemStyle.color,w=this._legend.itemStatuses[t]===0?"#808080":this._legend.textStyle.color,v=r||u?GeoGlobe.Util.getShadeColor(v,20):v,w=r||u?GeoGlobe.Util.getShadeColor(w,20):w;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "square2":this.legendCanvasContext.rect(g-this._legend.itemSize/
...
this.parts.length;c++)for(e=0;e<this.parts[c].cubes.length;e++){var r=0;for(f=e;f>0;f--)r+=this.parts[c].cubes[f-1].height;this.parts[c].cubes[e].vertexs=[[m+c*(g+j),l-r],[m+c*(g+j)+h*Math.cos(b),l-h*Math.sin(b)-r],[m+c*(g+j)+h*Math.cos(b)-g,l-h*Math.sin(b)-r],[m+c*(g+j)-g,l-r]]}break;case "pie":var u,v,w,x,C,B=Math.PI*2/50;for(c=0;c<1;c++){f=this.parts[c].size/2;m=f>g?f-g:0;r=new this.Point(0,0,-h/2);u=new this.Point(0,0,h/2);v=[];w=[];x=[];C=[];for(l=0;l<=Math.PI*2;)v.push(new this.Point(f*Math.cos(l),
f*Math.sin(l),-h/2)),w.push(new this.Point(f*Math.cos(l),f*Math.sin(l),h/2)),m>0&&(x.push(new this.Point(m*Math.cos(l),m*Math.sin(l),-h/2)),C.push(new this.Point(m*Math.cos(l),m*Math.sin(l),h/2))),l+=B;v.push(new this.Point(f,0,-h/2));w.push(new this.Point(f,0,h/2));m>0&&(x.push(new this.Point(m,0,-h/2)),C.push(new this.Point(m,0,h/2)));e=Math.cos(b);var A=Math.sin(b),z;l=r.y*e-r.z*A;z=r.z*e+r.y*A;r.y=l;r.z=z;l=u.y*e-u.z*A;z=u.z*e+u.y*A;u.y=l;u.z=z;for(f=0;f<50;f++)if(l=v[f].y*e-v[f].z*A,z=v[f].z*
e+v[f].y*A,v[f].y=l,v[f].z=z,l=w[f].y*e-w[f].z*A,z=w[f].z*e+w[f].y*A,w[f].y=l,w[f].z=z,m>0)l=x[f].y*e-x[f].z*A,z=x[f].z*e+x[f].y*A,x[f].y=l,x[f].z=z,l=C[f].y*e-C[f].z*A,z=C[f].z*e+C[f].y*A,C[f].y=l,C[f].z=z;for(e=0;e<this.parts[c].sectors.length;e++){l=this.parts[c].sectors[e].angle;A=0;for(f=e;f>0;f--)A+=this.parts[c].sectors[f-1].angle;f=A+l;this.parts[c].sectors[e].startIndex=e===0?Math.round(A/B):this.parts[c].sectors[e-1].endIndex;this.parts[c].sectors[e].endIndex=Math.round(f/B)}this.parts[c].uCentrePoint=
r;this.parts[c].tCentrePoint=u;this.parts[c].oUnderPoints=v;this.parts[c].oTopPoints=w;if(m>0)this.parts[c].iUnderPoints=x,this.parts[c].iTopPoints=C}}};this.MarkPoint.prototype.update=function(){this.energy+=this.velocity;this.energy>1&&(this.energy=1);a.DRAWDONE=this.energy===1};this.MarkPoint.prototype.isPointInPath=function(c,e,f){var h,j,l;switch(d){case "column":for(h=0;h<this.parts.length;h++)for(j=0;j<this.parts[h].cubes.length;j++)if(this.parts[h].cubes[j].height>0&&(c.beginPath(),c.moveTo(this.parts[h].cubes[j].vertexs[0][0],
...
j;return}break;case "pie":for(h=0;h<1;h++){var r=this.parts[h].tCentrePoint,u=this.parts[h].oUnderPoints,v=this.parts[h].oTopPoints,w=this.parts[h].iUnderPoints,x=this.parts[h].iTopPoints,C=!1;this.parts[h].size/2>g&&(C=!0);var B=Math.round(25),A=[],z=[],y=[];l=[];for(j=0;j<this.parts[h].sectors.length;j++)A.push(this.parts[h].sectors[j].angle),z.push(this.parts[h].sectors[j].startIndex),y.push(Math.round(this.parts[h].sectors[j].endIndex*this.energy)),l.push(b[j]?b[j]:m.color);for(j=A.length-1;j>=
0;j--)if(A[j]>0){c.beginPath();if(z[j]>B){c.moveTo(v[y[j]].get2d().x,v[y[j]].get2d().y);for(l=y[j]-1;l>=z[j];l--)c.lineTo(v[l].get2d().x,v[l].get2d().y);if(C){c.lineTo(x[z[j]].get2d().x,x[z[j]].get2d().y);for(l=z[j];l<=y[j];l++)c.lineTo(w[l].get2d().x,w[l].get2d().y);c.lineTo(x[y[j]].get2d().x,x[y[j]].get2d().y)}else c.lineTo(r.get2d().x,r.get2d().y)}else if(y[j]<B){c.moveTo(u[y[j]].get2d().x,u[y[j]].get2d().y);for(l=y[j]-1;l>=z[j];l--)c.lineTo(u[l].get2d().x,u[l].get2d().y);c.lineTo(v[z[j]].get2d().x,
v[z[j]].get2d().y);if(C)for(l=z[j];l<=y[j];l++)c.lineTo(x[l].get2d().x,x[l].get2d().y);else c.lineTo(r.get2d().x,r.get2d().y);c.lineTo(v[y[j]].get2d().x,v[y[j]].get2d().y)}else{c.moveTo(v[y[j]].get2d().x,v[y[j]].get2d().y);for(l=y[j]-1;l>=B;l--)c.lineTo(v[l].get2d().x,v[l].get2d().y);for(l=B;l>=z[j];l--)c.lineTo(u[l].get2d().x,u[l].get2d().y);c.lineTo(v[z[j]].get2d().x,v[z[j]].get2d().y);if(C){for(l=z[j];l<=B;l++)c.lineTo(x[l].get2d().x,x[l].get2d().y);for(l=B;l<=y[j];l++)c.lineTo(w[l].get2d().x,
w[l].get2d().y)}else c.lineTo(r.get2d().x,r.get2d().y)}if(c.isPointInPath(e,f)){a.hoveredMarkPoint=this;this.hActive=h;this.vActive=j;return}}}}};this.MarkPoint.prototype.draw=function(c){var e=a._rendererOptions.markPoint.slope;this.update();var f,n,q;q=!1;var t;switch(d){case "column":for(f=0;f<this.parts.length;f++)for(n=0;n<this.parts[f].cubes.length;n++)if(this.parts[f].cubes[n].height>0&&(q=!0,t=b[n]?b[n]:m.color,a.hoveredMarkPoint===this&&f===this.hActive&&n===this.vActive&&(t=GeoGlobe.Util.getShadeColor(t,
20)),c.globalAlpha=l,c.globalCompositeOperation="source-over",c.shadowBlur=0,c.shadowOffsetX=0,c.shadowOffsetY=0,c.beginPath(),c.moveTo(this.parts[f].cubes[n].vertexs[0][0],this.parts[f].cubes[n].vertexs[0][1]),c.lineTo(this.parts[f].cubes[n].vertexs[0][0],this.parts[f].cubes[n].vertexs[0][1]-this.parts[f].cubes[n].height*this.energy),c.lineTo(this.parts[f].cubes[n].vertexs[3][0],this.parts[f].cubes[n].vertexs[3][1]-this.parts[f].cubes[n].height*this.energy),c.lineTo(this.parts[f].cubes[n].vertexs[3][0],
this.parts[f].cubes[n].vertexs[3][1]),c.closePath(),c.fillStyle=t,c.fill(),h!==0))c.beginPath(),c.moveTo(this.parts[f].cubes[n].vertexs[0][0],this.parts[f].cubes[n].vertexs[0][1]),c.lineTo(this.parts[f].cubes[n].vertexs[1][0],this.parts[f].cubes[n].vertexs[1][1]),c.lineTo(this.parts[f].cubes[n].vertexs[1][0],this.parts[f].cubes[n].vertexs[1][1]-this.parts[f].cubes[n].height*this.energy),c.lineTo(this.parts[f].cubes[n].vertexs[0][0],this.parts[f].cubes[n].vertexs[0][1]-this.parts[f].cubes[n].height*
this.energy),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(t,-40),c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[n].vertexs[0][0],this.parts[f].cubes[n].vertexs[0][1]-this.parts[f].cubes[n].height*this.energy),c.lineTo(this.parts[f].cubes[n].vertexs[1][0],this.parts[f].cubes[n].vertexs[1][1]-this.parts[f].cubes[n].height*this.energy),c.lineTo(this.parts[f].cubes[n].vertexs[2][0],this.parts[f].cubes[n].vertexs[2][1]-this.parts[f].cubes[n].height*this.energy),c.lineTo(this.parts[f].cubes[n].vertexs[3][0],
this.parts[f].cubes[n].vertexs[3][1]-this.parts[f].cubes[n].height*this.energy),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(t,-20),c.fill(),c.shadowColor=m.shadowColor,c.shadowBlur=m.shadowBlur,c.shadowOffsetX=m.shadowOffsetX,c.shadowOffsetY=m.shadowOffsetY,c.globalCompositeOperation="destination-over",c.beginPath(),c.moveTo(this.parts[f].cubes[n].vertexs[1][0],this.parts[f].cubes[n].vertexs[1][1]),c.lineTo(this.parts[f].cubes[n].vertexs[1][0],this.parts[f].cubes[n].vertexs[1][1]-this.parts[f].cubes[n].height*
this.energy),c.lineTo(this.parts[f].cubes[n].vertexs[2][0],this.parts[f].cubes[n].vertexs[2][1]-this.parts[f].cubes[n].height*this.energy),c.lineTo(this.parts[f].cubes[n].vertexs[2][0],this.parts[f].cubes[n].vertexs[2][1]),c.closePath(),c.fillStyle=t,c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[n].vertexs[2][0],this.parts[f].cubes[n].vertexs[2][1]),c.lineTo(this.parts[f].cubes[n].vertexs[2][0],this.parts[f].cubes[n].vertexs[2][1]-this.parts[f].cubes[n].height*this.energy),c.lineTo(this.parts[f].cubes[n].vertexs[3][0],
this.parts[f].cubes[n].vertexs[3][1]-this.parts[f].cubes[n].height*this.energy),c.lineTo(this.parts[f].cubes[n].vertexs[3][0],this.parts[f].cubes[n].vertexs[3][1]),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(t,-40),c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[n].vertexs[0][0],this.parts[f].cubes[n].vertexs[0][1]),c.lineTo(this.parts[f].cubes[n].vertexs[1][0],this.parts[f].cubes[n].vertexs[1][1]),c.lineTo(this.parts[f].cubes[n].vertexs[2][0],this.parts[f].cubes[n].vertexs[2][1]),c.lineTo(this.parts[f].cubes[n].vertexs[3][0],
this.parts[f].cubes[n].vertexs[3][1]),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(t,-20),c.fill();if(q)c.lineWidth=0.3,c.globalAlpha=1,c.globalCompositeOperation="destination-over",c.shadowBlur=0,c.shadowOffsetX=0,c.shadowOffsetY=0,c.strokeStyle="#fff",c.beginPath(),c.moveTo(this.x-this.parts.length/2*g-(this.parts.length/2-0.5)*j-5,this.y),c.lineTo(this.x+this.parts.length/2*g+(this.parts.length/2-0.5)*j+5,this.y),c.closePath(),c.stroke(),h!==0&&(c.beginPath(),c.moveTo(this.x-(h/2+5)*Math.cos(e),
this.y+(h/2+5)*Math.sin(e)),c.lineTo(this.x+(h/2+5)*Math.cos(e),this.y-(h/2+5)*Math.sin(e)),c.closePath(),c.stroke());break;case "pie":c.globalAlpha=l;for(f=0;f<1;f++){t=this.parts[f].uCentrePoint;var r=this.parts[f].tCentrePoint,u=this.parts[f].oUnderPoints,v=this.parts[f].oTopPoints,w=this.parts[f].iUnderPoints,x=this.parts[f].iTopPoints,C=!1;this.parts[f].size/2>g&&(C=!0);var B=Math.round(25),A=[],z=[],y=[],E=[];for(n=0;n<this.parts[f].sectors.length;n++)A.push(this.parts[f].sectors[n].angle),
z.push(this.parts[f].sectors[n].startIndex),y.push(Math.round(this.parts[f].sectors[n].endIndex*this.energy)),E.push(b[n]?b[n]:m.color);for(n=A.length-1;n>=0;n--)A[n]>0&&a.hoveredMarkPoint===this&&f===this.hActive&&n===this.vActive&&(E[n]=GeoGlobe.Util.getShadeColor(E[n],10));for(n=A.length-1;n>=0;n--)if(A[n]>0){c.globalCompositeOperation="destination-over";c.beginPath();c.moveTo(u[y[n]].get2d().x,u[y[n]].get2d().y);for(q=y[n]-1;q>=z[n];q--)c.lineTo(u[q].get2d().x,u[q].get2d().y);if(C)for(q=z[n];q<=
y[n];q++)c.lineTo(w[q].get2d().x,w[q].get2d().y);else c.lineTo(t.get2d().x,t.get2d().y);c.fillStyle=E[n];c.fill()}if(e!==0){for(n=A.length-1;n>=0;n--)if(A[n]>0)c.globalCompositeOperation="source-over",c.beginPath(),c.moveTo(u[y[n]].get2d().x,u[y[n]].get2d().y),C?(c.lineTo(w[y[n]].get2d().x,w[y[n]].get2d().y),c.lineTo(x[y[n]].get2d().x,x[y[n]].get2d().y)):(c.lineTo(t.get2d().x,t.get2d().y),c.lineTo(r.get2d().x,r.get2d().y)),c.lineTo(v[y[n]].get2d().x,v[y[n]].get2d().y),c.moveTo(u[z[n]].get2d().x,u[z[n]].get2d().y),
C?(c.lineTo(w[z[n]].get2d().x,w[z[n]].get2d().y),c.lineTo(x[z[n]].get2d().x,x[z[n]].get2d().y)):(c.lineTo(t.get2d().x,t.get2d().y),c.lineTo(r.get2d().x,r.get2d().y)),c.lineTo(v[z[n]].get2d().x,v[z[n]].get2d().y),c.fillStyle=GeoGlobe.Util.getShadeColor(E[n],-20),c.fill();if(C)for(n=A.length-1;n>=0;n--)if(A[n]>0){c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(w[y[n]].get2d().x,w[y[n]].get2d().y);if(z[n]<B&&y[n]>B){for(q=y[n]-1;q>=B;q--)c.lineTo(w[q].get2d().x,w[q].get2d().y);for(q=
B;q<=y[n];q++)c.lineTo(x[q].get2d().x,x[q].get2d().y);c.moveTo(w[z[n]].get2d().x,w[z[n]].get2d().y);for(q=z[n]+1;q<=B;q++)c.lineTo(w[q].get2d().x,w[q].get2d().y);for(q=B;q>=z[n];q--)c.lineTo(x[q].get2d().x,x[q].get2d().y)}else{for(q=y[n]-1;q>=z[n];q--)c.lineTo(w[q].get2d().x,w[q].get2d().y);for(q=z[n];q<=y[n];q++)c.lineTo(x[q].get2d().x,x[q].get2d().y)}c.fillStyle=GeoGlobe.Util.getShadeColor(E[n],-20);c.fill()}for(n=A.length-1;n>=0;n--)if(A[n]>0){if(z[n]<B&&y[n]>B){c.globalCompositeOperation="destination-over";
c.beginPath();c.moveTo(u[y[n]].get2d().x,u[y[n]].get2d().y);for(q=y[n]-1;q>=B;q--)c.lineTo(u[q].get2d().x,u[q].get2d().y);for(q=B;q<=y[n];q++)c.lineTo(v[q].get2d().x,v[q].get2d().y);c.fillStyle=GeoGlobe.Util.getShadeColor(E[n],-20);c.fill();c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(u[z[n]].get2d().x,u[z[n]].get2d().y);for(q=z[n]+1;q<=B;q++)c.lineTo(u[q].get2d().x,u[q].get2d().y);for(q=B;q>=z[n];q--)c.lineTo(v[q].get2d().x,v[q].get2d().y)}else{c.globalCompositeOperation="source-over";
c.beginPath();c.moveTo(u[y[n]].get2d().x,u[y[n]].get2d().y);for(q=y[n]-1;q>=z[n];q--)c.lineTo(u[q].get2d().x,u[q].get2d().y);for(q=z[n];q<=y[n];q++)c.lineTo(v[q].get2d().x,v[q].get2d().y)}c.fillStyle=GeoGlobe.Util.getShadeColor(E[n],-20);c.fill()}for(n=A.length-1;n>=0;n--)if(A[n]>0){c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(v[y[n]].get2d().x,v[y[n]].get2d().y);for(q=y[n]-1;q>=z[n];q--)c.lineTo(v[q].get2d().x,v[q].get2d().y);if(C)for(q=z[n];q<=y[n];q++)c.lineTo(x[q].get2d().x,
x[q].get2d().y);else c.lineTo(r.get2d().x,r.get2d().y);c.fillStyle=E[n];c.fill()}}}}}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].style.position="absolute";this.div.appendChild(this.canvas[0])},
...
g;this.legendCanvas.height=b;var h=function(b,c,d){this.legendCanvas.width=g;for(var e=!1,f,h,n=0,q=this._legend.vLegendLabels.length;n<q;n++){h=0;for(var t=this._legend.col;h<t;h++)if(n%this._legend.col===h){f=10+this._legend.itemWidth/2;for(var r=0;r<h;r++)f+=a[r]+10}h=10+this._legend.itemHeight/2+((this._legend.itemHeight<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemHeight)+10)*~~(n/this._legend.col);r=t=!1;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-
this._legend.itemWidth/2,h-this._legend.itemHeight/2,this._legend.itemWidth,this._legend.itemHeight);b==="mousemove"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(e=t=!0);b==="mousedown"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(r=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;
this.legendCanvasContext.rect(f+this._legend.itemWidth/2+10,h-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this._legend.vLegendLabels[n].toString()).width,this._legend.textStyle.fontSize);b==="mousemove"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(e=t=!0);b==="mousedown"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(r=!0);if(r)this._legend.itemStatuses[n]=this._legend.itemStatuses[n]===0?1:0,this.SWITCH=!0,this.redraw();
var u=this._legend.itemStatuses[n]===0?"#808080":this._legend.itemColors[n]?this._legend.itemColors[n]:this._rendererOptions.markPoint.itemStyle.color,v=this._legend.itemStatuses[n]===0?"#808080":this._legend.textStyle.color,u=t||r?GeoGlobe.Util.getShadeColor(u,20):u,v=t||r?GeoGlobe.Util.getShadeColor(v,20):v;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-this._legend.itemWidth/2,h-this._legend.itemHeight/2,this._legend.itemWidth,this._legend.itemHeight);this.legendCanvasContext.fillStyle=
u;this.legendCanvasContext.fill();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.textAlign="left";this.legendCanvasContext.textBaseline="middle";this.legendCanvasContext.fillStyle=v;this.legendCanvasContext.fillText(this._legend.vLegendLabels[n],f+this._legend.itemWidth/2+10,h)}this.legendCanvas.style.cursor=e?"pointer":"default"}.bind(this);this.legendCanvas.onmousedown=
...
GeoGlobe.Util.deepExtend({},{markFace:{nameField:"name",valueField:"value",hoverable:!0,clickable:!0,itemStyle:{color:"rgba(255,0,0,0)",borderColor:"#000",borderWidth:1,shadowColor:"#000",shadowBlur:0,shadowOffsetX:0,shadowOffsetY:0}},tooltip:{show:!0,backgroundColor:"#fff",borderColor:"#333",borderRadius:0,borderWidth:0,padding:10,textStyle:{color:"#000",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},this.rendererOptions)},_initMarkFace:function(){var a=this,b=this._rendererOptions.markFace.itemStyle;
...
this._legend.right!==null?this._legend.right+"px":null;this.legendDiv.style.top=this._legend.top!==null?this._legend.top+"px":null;this.legendDiv.style.bottom=this._legend.bottom!==null?this._legend.bottom+"px":null;this.legendCanvas=document.createElement("canvas");this.legendCanvasContext=this.legendCanvas.getContext("2d");this.legendCanvas.style.display="block";this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+
"px "+this._legend.textStyle.fontFamily;this.legendDiv.appendChild(this.legendCanvas);this.div.appendChild(this.legendDiv);for(var b=[],c=null,d=0,e=this.legendLabels.length;d<e;d++)for(var c=this._legend.itemSize+10+this.legendCanvasContext.measureText(this.legendLabels[d].toString()).width,f=this._legend.col,g=0;g<f;g++)d%this._legend.col===g&&(!b[g]||b[g]<c)&&(b[g]=c);for(var h=10,c=10,d=0,e=b.length;d<e;d++)h+=b[d]+10;c+=((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:
this._legend.itemSize)+10)*(~~(this.legendLabels.length/this._legend.col)+(this.legendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=h;this.legendCanvas.height=c;var j=function(a,c,d,e){this.legendCanvas.width=h;for(var a=!1,f,g,j=0,t=this.legendLabels.length;j<t;j++){g=0;for(var r=this._legend.col;g<r;g++)if(j%this._legend.col===g){f=10+this._legend.itemSize/2;for(var u=0;u<g;u++)f+=b[u]+10}g=10+this._legend.itemSize/2+((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:
this._legend.itemSize)+10)*~~(j/this._legend.col);u=r=!1;this.legendCanvasContext.beginPath();switch(this._legend.symbol){case "ring":this.legendCanvasContext.arc(f,g,this._legend.itemSize/2,0,Math.PI*2,!1);break;case "circle":this.legendCanvasContext.arc(f,g,this._legend.itemSize/2,0,Math.PI*2,!1)}c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(a=r=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);this.legendCanvasContext.beginPath();
this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(f+this._legend.itemSize/2+10,g-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this.legendLabels[j].toString()).width,this._legend.textStyle.fontSize);c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(a=r=!0);c==="mousedown"&&d!==void 0&&
e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);u&&(this._legend.itemStatuses[j]=this._legend.itemStatuses[j]===0?1:0,this.drawCanvas());var v=this._legend.itemColors[j],w=this._legend.textStyle.color,v=r||u?GeoGlobe.Util.getShadeColor(v,20):v,w=r||u?GeoGlobe.Util.getShadeColor(w,20):w;this.legendCanvasContext.beginPath();switch(this._legend.symbol){case "ring":this.legendCanvasContext.arc(f,g,this._legend.itemSize/2,0,Math.PI*2,!1);break;case "circle":this.legendCanvasContext.arc(f,
...
e){b=10+this._legend_rightop.itemSize/2;for(var f=0;f<e;f++)b+=a[f]+10}d=this._legend_rightop.itemSize/2+((this._legend_rightop.itemSize<this._legend_rightop.textStyle.fontSize?this._legend_rightop.textStyle.fontSize:this._legend_rightop.itemSize)+10)*~~(c/this._legend_rightop.col);var f=this._rendererOptions.markPoint.itemStyle.color,m=this._legend_rightop.textStyle.color;this.legendCanvasContext2.beginPath();this.legendCanvasContext2.arc(b,d,this._legend_rightop.itemSize_circle[0]/2,0,Math.PI*2,
...
this.legendCanvasContext2.fillStyle=m;this.legendCanvasContext2.fillText(this._legend_rightop.vLegendLabels[1],b+(this._legend_rightop.itemWidth+10)*2+15,d);this.legendCanvasContext2.beginPath();this.legendCanvasContext2.arc(b+(this._legend_rightop.itemWidth+10)*4,d,this._legend_rightop.itemSize_ringSmall[0]/2,0,Math.PI*2,!1);this.legendCanvasContext2.fillStyle=f;this.legendCanvasContext2.fill();for(e=0;e<3;)this.legendCanvasContext2.beginPath(),this.legendCanvasContext2.arc(b+(this._legend_rightop.itemWidth+
10)*4,d,this._legend_rightop.itemSize_ringSmall[e]/2,0,Math.PI*2,!1),this.legendCanvasContext2.fillStyle=f,this.legendCanvasContext2.fill(),e++;this.legendCanvasContext2.font=this._legend_rightop.textStyle.fontStyle+" "+this._legend_rightop.textStyle.fontWeight+" "+this._legend_rightop.textStyle.fontSize+"px "+this._legend_rightop.textStyle.fontFamily;this.legendCanvasContext2.textAlign="left";this.legendCanvasContext2.textBaseline="middle";this.legendCanvasContext2.fillStyle=m;this.legendCanvasContext2.fillText(this._legend_rightop.vLegendLabels[2],
...
g=c.getContext("2d");c.width=c.height=b[1];g.drawImage(e,0,0,b[1],b[1]);for(var h=g.getImageData(0,0,b[1],b[1]),j=h.data,l=GeoGlobe.Util.getRgbColor(d).slice(4).split(")")[0].split(","),m=0,o=j.length;m<o;m+=4)j[m]=j[m]=+l[0],j[m+1]===255&&(j[m+1]=+l[1]),j[m+2]===255&&(j[m+2]=+l[2]);g.putImageData(h,0,0);a.markClusterImages[b[1]]=c;a.drawCanvas()}}):this._rendererOptions.markCluster.symbolSrc.forEach(function(b,c){var d=a._rendererOptions.markCluster.symbolSize[c][1],e=new Image;e.width=d;e.height=
...
l=void 0,m=void 0,o=void 0,p=void 0,s=void 0,n=void 0;this.markPoints.forEach(function(a){l=Math.floor((a.mercator[0]-e._markPointSWMercator[0])/h);m=Math.floor((a.mercator[1]-e._markPointSWMercator[1])/h);o=l+"_"+m;if(g[o])g[o].count++,g[o].sumLonLat[0]+=a.lon,g[o].sumLonLat[1]+=a.lat,g[o].children.push(a);else if(g[o]={key:o,count:1,sumLonLat:[a.lon,a.lat],children:[a]},b>f)p=Math.floor((a.mercator[0]-e._markPointSWMercator[0])/j),s=Math.floor((a.mercator[1]-e._markPointSWMercator[1])/j),n=p+"_"+
s,g[o].parent=e.markClusterZoomMap[b-1].markClustersMap[n]});for(o in g)g[o]=new this.MarkCluster(o,g[o].count,g[o].sumLonLat,g[o].children,g[o].parent);var q=this._mergeMarkClusters(g,h/2);this.markClusterZoomMap[b]={};this.markClusterZoomMap[b].zoom=b;this.markClusterZoomMap[b].markClusters=[];this.markClusterZoomMap[b].markClustersMap=q.markClustersMap;for(o in q.markClusters)this.markClusterZoomMap[b].markClusters.push(q.markClusters[o].init())}},_mergeMarkClusters:function(a,b){var c={},d;for(d in a)c[d]=
a[d];var e={},f={},g=void 0,h=void 0;for(d in a)if(g=a[d],!f[d])for(var h=d.split("_"),j=+h[0],l=+h[1],m=-1;m<=1;m++)for(var o=-1;o<=1;o++)if(!(m===0&&o===0)){var p=j+m+"_"+(l+o);if(h=a[p]){var s=GeoGlobe.Util.transferToMercator([g.sumLonLat[0]/g.count,g.sumLonLat[1]/g.count]),n=GeoGlobe.Util.transferToMercator([h.sumLonLat[0]/h.count,h.sumLonLat[1]/h.count]),q=s[0]-n[0],s=s[1]-n[1];Math.sqrt(q*q+s*s)<=b&&(e[d]=e[d]||[],e[d].push(h),f[p]=1)}}for(var t in e)if(d=a[t]){f=e[t];for(g=0;g<f.length;g++)if(a[f[g].key])d.count+=
...
"#a0d0ff","#b5c0ff","#c6adff","#d49bff","#e185ff","#ec6dff","#ff1edb"]},{},this.rendererOptions)},_initWindy:function(){var a=this;this.Windy=function(){var b=a._parent.map,c=a._rendererOptions.velocityScale,d=a._rendererOptions.maxWindIntensity,e=100,f=a._rendererOptions.lineWidth,g=a._rendererOptions.particleMultiplier,h=a._rendererOptions.opacity,j=a._rendererOptions.colors,l=[NaN,NaN,null],m=2*Math.PI,o=Math.pow(10,-5.2),p=function(a,b,c,d,e,f){var g=1-a,h=1-b,j=g*h;h*=a;g*=b;b*=a;a=c[0]*j+d[0]*
h+e[0]*g+f[0]*b;c=c[1]*j+d[1]*h+e[1]*g+f[1]*b;return[a,c,Math.sqrt(a*a+c*c)]},s=function(a,b){var c=a.data,d=b.data;return{header:a.header,data:function(a){return[c[a],d[a]]},interpolate:p}},n=function(a){var b=null,c=null;a.forEach(function(a){switch(a.header.parameterCategory+","+a.header.parameterNumber){case "2,2":b=a;break;case "2,3":c=a}});return s(b,c)},q=function(a){return a!==null&&a!==void 0},t=function(a,b,c){function d(b,c){var e=a[Math.round(b)];return e&&e[Math.round(c)]||l}d.release=
function(){a=[]};d.randomize=function(a){var c,e,f=0;do c=Math.round(Math.floor(Math.random()*b.width)+b.x),e=Math.round(Math.floor(Math.random()*b.height)+b.y);while(d(c,e)[2]===null&&f++<30);a.x=c;a.y=e;return a};c(b,d)},r=function(a,b,c){var d=a[0];return{x:Math.round(d[0]),y:Math.max(Math.floor(d[1],0),0),xMax:b,yMax:Math.min(Math.ceil(a[1][1],c),c-1),width:b,height:c}},u=function(a){return a/180*Math.PI},v=function(a){return a/(Math.PI/180)},w=function(a){return Math.log(Math.tan(a/2+Math.PI/
4))},x=function(a,c,d){if(b._mapCRS)var e=d.width/(d.east-d.west),f=d.height/(d.north-d.south),c=(u(c)-d.west)*e,a=(d.north-u(a))*f;else var f=w(d.south),g=w(d.north),e=d.width/(d.east-d.west),f=d.height/(g-f),a=w(u(a)),c=(u(c)-d.west)*e,a=(g-a)*f;return[c,a]},C=function(a,d,e){var f=[],g=a.x;(function I(){for(var h=Date.now();g<a.width;){for(var j=g,l=[],n=a.y;n<=a.yMax;n+=2){var p,q=j,s=n;p=d;if(b._mapCRS)var r=p.east-p.west,u=p.north-p.south,q=v(p.west)+q/p.width*v(r),s=v(p.north)-s/p.height*v(u);
else r=p.east-p.west,u=p.width/v(r)*360/(2*Math.PI),s=180/Math.PI*(2*Math.atan(Math.exp((p.height+u/2*Math.log((1+Math.sin(p.south))/(1-Math.sin(p.south)))-s)/u))-Math.PI/2),q=v(p.west)+q/p.width*v(r);p=[q,s];r=p[0];u=p[1];if(isFinite(r)&&(p=z(r,u))){var q=p[0]*c,s=p[1]*c,w=r,y=u,r=j,u=n,A=d,B=w<0?o:-o,C=y<0?o:-o,H=x(y,w+B,A),w=x(y+C,w,A),y=Math.cos(y/360*m);b._mapCRS&&(y=1);r=[(H[0]-r)/B/y,(H[1]-u)/B/y,(w[0]-r)/C,(w[1]-u)/C];p[0]=r[0]*q+r[2]*s;p[1]=r[1]*q+r[3]*s;l[n+1]=l[n]=p}}f[j+1]=f[j]=l;g+=2;
if(Date.now()-h>1E3){setTimeout(I,25);return}}t(f,a,e)})()},B=function(b,c){function l(a){return a.charAt(0)=="#"?a.substring(1,7):a}function m(){p.forEach(function(a){a.length=0});s.forEach(function(a){if(a.age>e)c.randomize(a).age=0;var b=a.x,d=a.y,f=c(b,d),g=f[2];g===null?a.age=e:(b+=f[0],d+=f[1],c(b,d)[2]!==null?(a.xt=b,a.yt=d,p[o.indexFor(g)].push(a)):(a.x=b,a.y=d));a.age+=1})}function n(){var a=t.globalCompositeOperation;t.globalCompositeOperation="destination-in";t.fillRect(b.x,b.y,b.width,
b.height);t.globalCompositeOperation=a;p.forEach(function(a,b){if(a.length>0)t.beginPath(),t.strokeStyle=o[b],a.forEach(function(a){t.moveTo(a.x,a.y);t.lineTo(a.xt,a.yt);a.x=a.xt;a.y=a.yt}),t.stroke()})}var o=function(a,b){var c=[];j.forEach(function(a){c.push("rgba("+parseInt(l(a).substring(0,2),16)+", "+parseInt(l(a).substring(2,4),16)+", "+parseInt(l(a).substring(4,6),16)+", "+h+")")});c.indexFor=function(a){return Math.floor(Math.min(a,b)/b*(c.length-1))};return c}(10,d),p=o.map(function(){return[]}),
q=Math.round(b.width*b.height*g);/android|blackberry|iemobile|ipad|iphone|ipod|opera mini|webos/i.test(navigator.userAgent)&&(q*=0.075);for(var s=[],r=0;r<q;r++)s.push(c.randomize({age:Math.floor(Math.random()*e)+0}));var t=a.canvasContext;t.lineWidth=f;t.fillStyle="rgba(0, 0, 0, 0.97)";(function J(){try{y.timer=setTimeout(function(){requestAnimationFrame(J);m();n()},50)}catch(a){console.error(a)}})()},A=function(){y.field&&y.field.release();y.timer&&clearTimeout(y.timer)},z=function(a){var b=n(a),
c=b.header,d=c.lo1,e=c.la1,f=c.dx,g=c.dy,a=c.nx,h=c.ny,j=new Date(c.refTime);j.setHours(j.getHours()+c.forecastTime);for(var l=[],c=0,j=Math.floor(a*f)>=360,m=0;m<h;m++){for(var o=[],p=0;p<a;p++,c++)o[p]=b.data(c);j&&o.push(o[0]);l[m]=o}return function(a,c){var h=(a-d-360*Math.floor((a-d)/360))/f,j=(e-c)/g,m=Math.floor(h),n=m+1,o=Math.floor(j),p=o+1,s;if(s=l[o]){var t=s[m],r=s[n];if(q(t)&&q(r)&&(s=l[p]))if(p=s[m],n=s[n],q(p)&&q(n))return b.interpolate(h-m,j-o,t,r,p,n)}return null}}(a.data),y={start:function(a,
b,c,d){d={south:u(d[0][1]),north:u(d[1][1]),east:u(d[1][0]),west:u(d[0][0]),width:b,height:c};A();C(r(a,b,c),d,function(a,b){y.field=b;B(a,b)})},stop:A};return y}},render:function(){this._init_RendererOptions();this._initWindy();this.setData(this.data);this.setVisible(this.visibility)},draw:function(){setTimeout(function(){this.windy.start([[0,0],this.size],this.size[0],this.size[1],this.bounds)}.bind(this),1)},onMove:function(){this.stopDraw()},onMoveEnd:function(){this.redraw()},onResize:function(){this.width=
...
c){var d=Array(c*c),e=Array(c),f=Array(c),g=Array(c),h,j,l,m,o,p;for(h=0;h<c;h++)for(m=0;m<c;m++)d[h*c+m]=h==m?1:0;for(m=0;m<c;m++)g[m]=0;for(h=0;h<c;h++){for(m=p=0;m<c;m++)if(g[m]!=1)for(o=0;o<c;o++)g[o]==0&&Math.abs(a[m*c+o])>=p&&(p=Math.abs(a[m*c+o]),l=m,j=o);++g[j];if(l!=j){for(m=0;m<c;m++)p=a[l*c+m],a[l*c+m]=a[j*c+m],a[j*c+m]=p;for(m=0;m<c;m++)p=d[l*c+m],d[l*c+m]=d[j*c+m],d[j*c+m]=p}f[h]=l;e[h]=j;if(a[j*c+j]==0)return!1;o=1/a[j*c+j];a[j*c+j]=1;for(m=0;m<c;m++)a[j*c+m]*=o;for(m=0;m<c;m++)d[j*
c+m]*=o;for(o=0;o<c;o++)if(o!=j){p=a[o*c+j];for(m=a[o*c+j]=0;m<c;m++)a[o*c+m]-=a[j*c+m]*p;for(m=0;m<c;m++)d[o*c+m]-=d[j*c+m]*p}}for(m=c-1;m>=0;m--)if(f[m]!=e[m])for(o=0;o<c;o++)p=a[o*c+f[m]],a[o*c+f[m]]=a[o*c+e[m]],a[o*c+e[m]]=p;return!0};kriging_variogram_gaussian=function(a,c,d,e,f){return c+(e-c)/d*(1-Math.exp(-(1/f)*Math.pow(a/d,2)))};kriging_variogram_exponential=function(a,c,d,e,f){return c+(e-c)/d*(1-Math.exp(-(1/f)*(a/d)))};kriging_variogram_spherical=function(a,c,d,e){if(a>d)return c+(e-
c)/d;return c+(e-c)/d*(1.5*(a/d)-0.5*Math.pow(a/d,3))};a.train=function(a,c,d,e,f,g){var h={t:a,x:c,y:d,nugget:0,range:0,sill:0,A:1/3,n:0};switch(e){case "gaussian":h.model=kriging_variogram_gaussian;break;case "exponential":h.model=kriging_variogram_exponential;break;case "spherical":h.model=kriging_variogram_spherical}var j,l,m,o,p=a.length,s=Array((p*p-p)/2);for(m=j=0;j<p;j++)for(l=0;l<j;l++,m++)s[m]=Array(2),s[m][0]=Math.pow(Math.pow(c[j]-c[l],2)+Math.pow(d[j]-d[l],2),0.5),s[m][1]=Math.abs(a[j]-
a[l]);s.sort(function(a,b){return a[0]-b[0]});h.range=s[(p*p-p)/2-1][0];var n=(p*p-p)/2>30?30:(p*p-p)/2,q=h.range/n,t=[0].rep(n),r=[0].rep(n);if(n<30)for(o=0;o<n;o++)t[o]=s[o][0],r[o]=s[o][1];else{for(o=m=l=j=0;j<n&&l<(p*p-p)/2;j++,m=0){for(;s[l][0]<=(j+1)*q;)if(t[o]+=s[l][0],r[o]+=s[l][1],l++,m++,l>=(p*p-p)/2)break;m>0&&(t[o]/=m,r[o]/=m,o++)}if(o<2)return h}p=o;h.range=t[p-1]-t[0];m=[1].rep(2*p);l=Array(p);o=h.A;for(j=0;j<p;j++){switch(e){case "gaussian":m[j*2+1]=1-Math.exp(-(1/o)*Math.pow(t[j]/
h.range,2));break;case "exponential":m[j*2+1]=1-Math.exp(-(1/o)*t[j]/h.range);break;case "spherical":m[j*2+1]=1.5*(t[j]/h.range)-0.5*Math.pow(t[j]/h.range,3)}l[j]=r[j]}j=kriging_matrix_transpose(m,p,2);e=kriging_matrix_multiply(j,m,2,p,2);e=kriging_matrix_add(e,kriging_matrix_diag(1/g,2),2,2);g=e.slice(0);kriging_matrix_chol(e,2)?kriging_matrix_chol2inv(e,2):(kriging_matrix_solve(g,2),e=g);p=kriging_matrix_multiply(kriging_matrix_multiply(e,j,2,2,p),l,2,p,1);h.nugget=p[0];h.sill=p[1]*h.range+h.nugget;
p=h.n=c.length;g=Array(p*p);for(j=0;j<p;j++){for(l=0;l<j;l++)g[j*p+l]=h.model(Math.pow(Math.pow(c[j]-c[l],2)+Math.pow(d[j]-d[l],2),0.5),h.nugget,h.range,h.sill,h.A),g[l*p+j]=g[j*p+l];g[j*p+j]=h.model(0,h.nugget,h.range,h.sill,h.A)}c=kriging_matrix_add(g,kriging_matrix_diag(f,p),p,p);d=c.slice(0);kriging_matrix_chol(c,p)?kriging_matrix_chol2inv(c,p):(kriging_matrix_solve(d,p),c=d);g=c.slice(0);a=kriging_matrix_multiply(c,a,p,p,1);h.K=g;h.M=a;return h};a.predict=function(a,c,d){var e,f=Array(d.n);for(e=
...
_initPlot:function(a,b){this.grid||this._initGrid();this.canvasContext.globalAlpha=this._rendererOptions.opacity;var c=this.canvas,d=this.canvasContext,e=this.grid,a=[this.bounds[0][0],this.bounds[1][0]],b=[this.bounds[0][1],this.bounds[1][1]],f=this._rendererOptions.colors,g=[a[1]-a[0],b[1]-b[0],e.zlim[1]-e.zlim[0]],h,j,l,m,o,p,s=void 0;m=void 0;var n=e.length,q=e[0].length,t=Math.ceil(e.width*c.width/(a[1]-a[0])),r=Math.ceil(e.width*c.height/(b[1]-b[0]));for(h=0;h<n;h++){ly=void 0;for(j=0;j<q;j++)if(e[h][j]!=
void 0){l=c.width*(h*e.width+e.xlim[0]-a[0])/g[0];m=c.height*(1-(j*e.width+e.ylim[0]-b[0])/g[1]);Array.isArray(f[0])?(o=e[h][j],f.forEach(function(a){o>a[0]&&(p=a[1])})):(o=(e[h][j]-e.zlim[0])/g[2],o<0&&(o=0),o>1&&(o=1),p=f[Math.floor((f.length-1)*o)]);d.fillStyle=p;var u=Math.round(l-t/2);m=Math.round(m-r/2);var v=t,w=r;ly!==void 0&&(w=ly-m);s!==void 0&&(v=s-u);ly=m;l=u;d.fillRect(u,m,v,w)}s=l}},render:function(a){this._init_RendererOptions();this.setData(this.data);this.setVisible(this.visibility);
